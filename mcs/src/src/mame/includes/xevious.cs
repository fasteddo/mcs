...
namespace mame
{
    ...
    {
        required_shared_ptr_uint8_t m_xevious_sr1;
        required_shared_ptr_uint8_t m_xevious_sr2;
        required_shared_ptr_uint8_t m_xevious_sr3;
        required_shared_ptr_uint8_t m_xevious_fg_colorram;
        required_shared_ptr_uint8_t m_xevious_bg_colorram;
        required_shared_ptr_uint8_t m_xevious_fg_videoram;
        required_shared_ptr_uint8_t m_xevious_bg_videoram;
