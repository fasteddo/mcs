...
namespace mame
{
    public partial class pacman_state : driver_device
    {
        ...
        optional_shared_ptr_byte  m_spriteram;
        optional_shared_ptr_byte  m_spriteram2;
        optional_shared_ptr_byte  m_s2650_spriteram;
        required_shared_ptr_byte  m_videoram;
        optional_shared_ptr_byte  m_colorram;
        optional_shared_ptr_byte  m_s2650games_tileram;
        optional_shared_ptr_byte  m_rocktrv2_prot_data;
            ...
            : base(mconfig, type, tag)
        {
            ...
            m_spriteram = new optional_shared_ptr_byte(this, "spriteram");
            m_spriteram2 = new optional_shared_ptr_byte(this, "spriteram2");
            m_s2650_spriteram = new optional_shared_ptr_byte(this, "s2650_spriteram");
            m_videoram = new required_shared_ptr_byte(this, "videoram");
            m_colorram = new optional_shared_ptr_byte(this, "colorram");
            m_s2650games_tileram = new optional_shared_ptr_byte(this, "s2650_tileram");
            m_rocktrv2_prot_data = new optional_shared_ptr_byte(this, "rocktrv2_prot");
