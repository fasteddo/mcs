...
namespace mame
{
    ...
    partial class atarisy2 : global_object
    {
    ...
    partial class atarisy2_state : atarigen_state
    {
        ...
        public void init_paperboy()
        {
            ...
            for (int i = 0x10000; i < 0x90000; i += 0x20000)
            {
                ...
                memcpy(new PointerU8(cpu1, i + 0x10000), new PointerU8(cpu1, i), 0x8000);  //memcpy(&cpu1[i + 0x10000], &cpu1[i], 0x8000);
                memcpy(new PointerU8(cpu1, i + 0x18000), new PointerU8(cpu1, i), 0x8000);  //memcpy(&cpu1[i + 0x18000], &cpu1[i], 0x8000);
            }
