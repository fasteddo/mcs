...
namespace mame
{
    partial class atarisy2_state : driver_device
    {
        ...
        protected override void machine_start()
        {
            ...
            save_item(g.NAME(new { m_interrupt_enable }));
            save_item(g.NAME(new { m_scanline_int_state }));
            save_item(g.NAME(new { m_video_int_state }));
            save_item(g.NAME(new { m_p2portwr_state }));
            save_item(g.NAME(new { m_p2portrd_state }));
            save_item(g.NAME(new { m_sound_reset_state }));
    ...
    partial class atarisy2 : construct_ioport_helper
    {
        ...
        void construct_ioport_paperboy(device_t owner, ioport_list portlist, ref string errorbuf)
        {
            ...
            PORT_BIT( 0x01, g.IP_ACTIVE_HIGH, g.IPT_CUSTOM ); PORT_READ_LINE_DEVICE_MEMBER("soundlatch", () => { return ((generic_latch_8_device)atarisy2_state.subdevice("soundlatch")).pending_r(); }); // P1TALK
            PORT_BIT( 0x02, g.IP_ACTIVE_HIGH, g.IPT_CUSTOM ); PORT_READ_LINE_DEVICE_MEMBER("mainlatch", () => { return ((generic_latch_8_device)atarisy2_state.subdevice("mainlatch")).pending_r(); }); // P2TALK
            PORT_BIT( 0x04, g.IP_ACTIVE_LOW, g.IPT_CUSTOM );
            PORT_BIT( 0x08, g.IP_ACTIVE_HIGH, g.IPT_UNUSED );
            PORT_BIT( 0x10, g.IP_ACTIVE_LOW, g.IPT_SERVICE );
            PORT_BIT( 0x20, g.IP_ACTIVE_LOW, g.IPT_COIN3 );
            PORT_BIT( 0x40, g.IP_ACTIVE_LOW, g.IPT_COIN1 );
            PORT_BIT( 0x80, g.IP_ACTIVE_LOW, g.IPT_COIN2 );

            PORT_START("1800");
            PORT_BIT( 0x01, g.IP_ACTIVE_LOW, g.IPT_UNUSED );
            PORT_BIT( 0x02, g.IP_ACTIVE_LOW, g.IPT_UNUSED );
            PORT_BIT( 0x04, g.IP_ACTIVE_LOW, g.IPT_UNKNOWN );
            PORT_BIT( 0x08, g.IP_ACTIVE_LOW, g.IPT_UNKNOWN );
            PORT_BIT( 0x10, g.IP_ACTIVE_HIGH, g.IPT_CUSTOM ); PORT_READ_LINE_DEVICE_MEMBER("mainlatch", () => { return ((generic_latch_8_device)atarisy2_state.subdevice("mainlatch")).pending_r(); }); // P2TALK
            PORT_BIT( 0x20, g.IP_ACTIVE_HIGH, g.IPT_CUSTOM ); PORT_READ_LINE_DEVICE_MEMBER("soundlatch", () => { return ((generic_latch_8_device)atarisy2_state.subdevice("soundlatch")).pending_r(); }); // P1TALK
            PORT_BIT( 0x40, g.IP_ACTIVE_LOW, g.IPT_BUTTON2 );
            PORT_BIT( 0x80, g.IP_ACTIVE_LOW, g.IPT_BUTTON1 );

            PORT_START("1801");
            PORT_BIT( 0x7f, g.IP_ACTIVE_LOW, g.IPT_UNUSED );
            PORT_SERVICE( 0x80, g.IP_ACTIVE_LOW );

            PORT_START("ADC0");
            PORT_BIT( 0xff, 0x80, g.IPT_AD_STICK_X ); PORT_MINMAX(0x10,0xf0); PORT_SENSITIVITY(100); PORT_KEYDELTA(10); PORT_PLAYER(1);

            PORT_START("ADC1");
            PORT_BIT( 0xff, 0x80, g.IPT_AD_STICK_Y ); PORT_MINMAX(0x10,0xf0); PORT_SENSITIVITY(100); PORT_KEYDELTA(10); PORT_PLAYER(1);

            PORT_START("ADC2");
            PORT_BIT( 0xff, g.IP_ACTIVE_LOW, g.IPT_UNUSED );
            ...
            PORT_START("DSW0");
            PORT_DIPNAME( 0x03, 0x00, g.DEF_STR( g.Coinage ) );      PORT_DIPLOCATION("6/7A:!8,!7");
            PORT_DIPSETTING(    0x03, g.DEF_STR( g._4C_1C ) );
            ...
            PORT_DIPSETTING(    0xe0, g.DEF_STR( g.Free_Play ) );

            PORT_START("DSW1");
            PORT_DIPNAME( 0x03, 0x00, g.DEF_STR( g.Difficulty ) );   PORT_DIPLOCATION("5/6A:!8,!7");
            PORT_DIPSETTING(    0x01, g.DEF_STR( g.Easy ) );
            PORT_DIPSETTING(    0x02, g.DEF_STR( g.Medium ) );
            PORT_DIPSETTING(    0x00, g.DEF_STR( g.Medium_Hard ) );
            PORT_DIPSETTING(    0x03, g.DEF_STR( g.Hard ) );
            PORT_DIPNAME( 0x0c, 0x00, g.DEF_STR( g.Bonus_Life ) );   PORT_DIPLOCATION("5/6A:!6,!5");
            PORT_DIPSETTING(    0x08, "10000" );
            PORT_DIPSETTING(    0x00, "15000" );
            PORT_DIPSETTING(    0x0c, "20000" );
            PORT_DIPSETTING(    0x04, g.DEF_STR( g.None ) );
            PORT_DIPNAME( 0x30, 0x00, g.DEF_STR( g.Lives ) );        PORT_DIPLOCATION("5/6A:!4,!3");
        ...
        void construct_ioport_720(device_t owner, ioport_list portlist, ref string errorbuf)
        {
            ...
            PORT_BIT( 0xff, 0x00, g.IPT_DIAL_V ); PORT_SENSITIVITY(50); PORT_KEYDELTA(10); PORT_NAME("Center"); PORT_CONDITION("SELECT",0x03,ioport_condition.condition_t.EQUALS,0x00);
            ...
            PORT_BIT( 0xff, 0x00, g.IPT_DIAL ); PORT_SENSITIVITY(50); PORT_KEYDELTA(10); PORT_FULL_TURN_COUNT(144); PORT_NAME("Rotate"); PORT_CONDITION("SELECT",0x03,ioport_condition.condition_t.EQUALS,0x00);

            PORT_START("FAKE_JOY_X");    // not direct mapped
            PORT_BIT( 0xff, 0x80, g.IPT_AD_STICK_X ); PORT_SENSITIVITY(100); PORT_KEYDELTA(10); PORT_CONDITION("SELECT",0x03,ioport_condition.condition_t.EQUALS,0x01);

            PORT_START("FAKE_JOY_Y");    // not direct mapped
            PORT_BIT( 0xff, 0x80, g.IPT_AD_STICK_Y ); PORT_SENSITIVITY(100); PORT_KEYDELTA(10); PORT_REVERSE(); PORT_CONDITION("SELECT",0x03,ioport_condition.condition_t.EQUALS,0x01);

            /* Let's assume we are using a 1200 count spinner.  We scale to get a 144 count.
             * 144/1200 = 0.12 = 12% */
            PORT_START("FAKE_SPINNER");  // not direct mapped
            PORT_BIT( 0xffff, 0x00, g.IPT_DIAL ); PORT_SENSITIVITY(12); PORT_KEYDELTA(10); PORT_CONDITION("SELECT",0x03,ioport_condition.condition_t.EQUALS,0x02);
            ...
            PORT_MODIFY("DSW1");
            PORT_DIPNAME( 0x03, 0x01, g.DEF_STR( g.Bonus_Life ) );       PORT_DIPLOCATION("5/6A:!8,!7");
            PORT_DIPSETTING(    0x01, "3000" );
            PORT_DIPSETTING(    0x00, "5000" );
            PORT_DIPSETTING(    0x02, "8000" );
            PORT_DIPSETTING(    0x03, "12000" );
            PORT_DIPNAME( 0x0c, 0x04, g.DEF_STR( g.Difficulty ) );       PORT_DIPLOCATION("5/6A:!6,!5");
            PORT_DIPSETTING(    0x04, g.DEF_STR( g.Easy ) );
            PORT_DIPSETTING(    0x00, g.DEF_STR( g.Medium ) );
            PORT_DIPSETTING(    0x08, g.DEF_STR( g.Hard ) );
            PORT_DIPSETTING(    0x0c, g.DEF_STR( g.Hardest ) );
    ...
    partial class atarisy2_state : driver_device
    {
        ...
        void atarisy2(machine_config config)
        {
            ...
            g.T11(config, m_maincpu, MASTER_CLOCK / 2);
            ...
            g.M6502(config, m_audiocpu, SOUND_CLOCK / 8);
            m_audiocpu.op[0].memory().set_addrmap(g.AS_PROGRAM, sound_map);
            m_audiocpu.op[0].execute().set_periodic_int(sound_irq_gen, attotime.from_hz(MASTER_CLOCK/2/16/16/16/10));

            adc0809_device adc = g.ADC0809(config, "adc", MASTER_CLOCK / 32); // 625 kHz
            ...
            g.EEPROM_2804(config, "eeprom");

            g.TIMER(config, "scantimer").configure_scanline(scanline_update, m_screen, 0, 64);

            g.WATCHDOG_TIMER(config, "watchdog").set_time(attotime.from_hz(MASTER_CLOCK/2/16/16/16/256));

            // video hardware
            g.GFXDECODE(config, "gfxdecode", "palette", gfx_atarisy2);
            g.PALETTE(config, "palette").set_format(2, RRRRGGGGBBBBIIII, 256);

            g.TILEMAP(config, m_playfield_tilemap, "gfxdecode", 2, 8,8, tilemap_standard_mapper.TILEMAP_SCAN_ROWS, 128,64).set_info_callback(get_playfield_tile_info);
            g.TILEMAP(config, m_alpha_tilemap, "gfxdecode", 2, 8,8, tilemap_standard_mapper.TILEMAP_SCAN_ROWS, 64,48, 0).set_info_callback(get_alpha_tile_info);

            g.ATARI_MOTION_OBJECTS(config, m_mob, 0, m_screen, s_mob_config);
            ...
            // sound hardware
            g.SPEAKER(config, "lspeaker").front_left();
            g.SPEAKER(config, "rspeaker").front_right();
        ...
        {
            atarisy2(config);
            g.SLAPSTIC<bool_const_true>(config, m_slapstic, 105);
            m_slapstic.op[0].set_range(m_maincpu, g.AS_PROGRAM, 0100000, 0100777, 0);
        ...
        public void _720(machine_config config)
        {
            ...
            g.SLAPSTIC<bool_const_true>(config, m_slapstic, 107);
            m_slapstic.op[0].set_range(m_maincpu, g.AS_PROGRAM, 0100000, 0100777, 0);
            m_slapstic.op[0].set_view(m_vmmu);
        }
    ...
    partial class atarisy2 : construct_ioport_helper
    {
        ...
        {
            g.ROM_REGION( 0x90000, "maincpu", 0 ), // 9*64k for T11 code
            g.ROM_LOAD16_BYTE( "cpu_l07.rv3", 0x008000, 0x004000, g.CRC("4024bb9b") + g.SHA1("9030ce5a6a1a3d769c699a92b32a55013f9766aa") ),
            g.ROM_LOAD16_BYTE( "cpu_n07.rv3", 0x008001, 0x004000, g.CRC("0260901a") + g.SHA1("39d786f5c440ca1fd529ee73e2a4d2406cd1db8f") ),
            g.ROM_LOAD16_BYTE( "cpu_f06.rv2", 0x010000, 0x004000, g.CRC("3fea86ac") + g.SHA1("90722bfd0426efbfb69714151f8644b56075b4c1") ),
            g.ROM_LOAD16_BYTE( "cpu_n06.rv2", 0x010001, 0x004000, g.CRC("711b17ba") + g.SHA1("7c9b19f754f1e3ba4d081edce2a39e81ce87f6bb") ),
            g.ROM_LOAD16_BYTE( "cpu_j06.rv1", 0x030000, 0x004000, g.CRC("a754b12d") + g.SHA1("7b07efe70f9696041355b72f5cded7fcbd8be460") ),
            g.ROM_LOAD16_BYTE( "cpu_p06.rv1", 0x030001, 0x004000, g.CRC("89a1ff9c") + g.SHA1("aa947e0726bb68164b9556d57daf6547b4580ed0") ),
            g.ROM_LOAD16_BYTE( "cpu_k06.rv1", 0x050000, 0x004000, g.CRC("290bb034") + g.SHA1("71dfceb6a8b3b0e3be2cc907c3d4b91fe6973fec") ),
            g.ROM_LOAD16_BYTE( "cpu_r06.rv1", 0x050001, 0x004000, g.CRC("826993de") + g.SHA1("59c6b87bcbca80b0a6192d7bb534a0747f32b907") ),
            g.ROM_LOAD16_BYTE( "cpu_l06.rv2", 0x070000, 0x004000, g.CRC("8a754466") + g.SHA1("2c4c6ca797c7f4349c2893d8c0ba7e2658fdca99") ),
            g.ROM_LOAD16_BYTE( "cpu_s06.rv2", 0x070001, 0x004000, g.CRC("224209f9") + g.SHA1("c41269bfadb8fff1c8ff0f6ea0b8e8b34feb49d6") ),

            g.ROM_REGION( 0x10000, "audiocpu", 0 ),    // 64k for 6502 code
            g.ROM_LOAD( "cpu_a02.rv3", 0x004000, 0x004000, g.CRC("ba251bc4") + g.SHA1("768e42608263205e412e651082ffa2a083b04644") ),
            g.ROM_LOAD( "cpu_b02.rv2", 0x008000, 0x004000, g.CRC("e4e7a8b9") + g.SHA1("f11a0cf40d5c51ff180f0fa1cf676f95090a1010") ),
            g.ROM_LOAD( "cpu_c02.rv2", 0x00c000, 0x004000, g.CRC("d44c2aa2") + g.SHA1("f1b00e36d87f6d77746cf003198c7f19aa2f4fab") ),

            g.ROM_REGION( 0x20000, "gfx1", 0 ),
            g.ROM_LOAD( "vid_a06.rv1", 0x000000, 0x008000, g.CRC("b32ffddf") + g.SHA1("5b7619008e34ed7f5eb5e85e5f45c375e078086a") ),
            g.ROM_LOAD( "vid_b06.rv1", 0x00c000, 0x004000, g.CRC("301b849d") + g.SHA1("d608a854027da5eb88c071df1d01f31124db89a8") ),
            g.ROM_LOAD( "vid_c06.rv1", 0x010000, 0x008000, g.CRC("7bb59d68") + g.SHA1("fcaa8bd32448d8f951ae446eb425b608f2cecbef") ),
            g.ROM_LOAD( "vid_d06.rv1", 0x01c000, 0x004000, g.CRC("1a1d4ba8") + g.SHA1("603d61fd17e312d0784d883a50ce6b03aba27d10") ),

            g.ROM_REGION( 0x40000, "gfx2", g.ROMREGION_INVERT ),
            g.ROM_LOAD( "vid_l06.rv1", 0x000000, 0x008000, g.CRC("067ef202") + g.SHA1("519f32995a32ed96086f4ed3d49530b6917ad7d3") ),
            g.ROM_LOAD( "vid_k06.rv1", 0x008000, 0x008000, g.CRC("76b977c4") + g.SHA1("09988aceaf398279556980e3a21c0dc1b619fb72") ),
            g.ROM_LOAD( "vid_j06.rv1", 0x010000, 0x008000, g.CRC("2a3cc8d0") + g.SHA1("c0165286486a0844baf99c782d2fffdd6ad003b6") ),
            g.ROM_LOAD( "vid_h06.rv1", 0x018000, 0x008000, g.CRC("6763a321") + g.SHA1("15ed912f0346f6b5c3ad23ff22e7493d31ad18a7") ),
            g.ROM_LOAD( "vid_s06.rv1", 0x020000, 0x008000, g.CRC("0a321b7b") + g.SHA1("681317494a0bd50569bb822783336e68551cfd5e") ),
            g.ROM_LOAD( "vid_p06.rv1", 0x028000, 0x008000, g.CRC("5bd089ee") + g.SHA1("9ac98391a6c70d3cfbe609342294668530d690b4") ),
            g.ROM_LOAD( "vid_n06.rv1", 0x030000, 0x008000, g.CRC("c34a517d") + g.SHA1("f0af3db87f73c1fad00a270269ba380898ef5a4b") ),
            g.ROM_LOAD( "vid_m06.rv1", 0x038000, 0x008000, g.CRC("df723956") + g.SHA1("613d398f30463086c0cc720a760bda652e0f3832") ),

            g.ROM_REGION( 0x2000, "gfx3", 0 ),
            g.ROM_LOAD( "vid_t06.rv1", 0x000000, 0x002000, g.CRC("60d7aebb") + g.SHA1("ad74221c4270496ebcfedd46ea16dca2cda1b4be") ),

            g.ROM_REGION( 0x200, "eeprom", 0 ),
            g.ROM_LOAD( "paperboy-eeprom.bin", 0x0000, 0x0200, g.CRC("756b90cc") + g.SHA1("b78762e354f1316087f9de4005734c343356c8ef") ),
        ...
        {
            g.ROM_REGION( 0x90000, "maincpu", 0 ),     // 9 * 64k T11 code
            g.ROM_LOAD16_BYTE( "136047-3126.7lm", 0x008000, 0x004000, g.CRC("43abd367") + g.SHA1("bb58c42f25ef0ee5357782652e9e2b28df0ba82e") ),
            g.ROM_LOAD16_BYTE( "136047-3127.7mn", 0x008001, 0x004000, g.CRC("772e1e5b") + g.SHA1("1ee9b6bd7b2a5e4866b7157db95ee38b53f5c4ce") ),
            g.ROM_LOAD16_BYTE( "136047-3128.6fh", 0x010000, 0x010000, g.CRC("bf6f425b") + g.SHA1("22732465959c2d30383523e0354b8d3759963765") ),
            g.ROM_LOAD16_BYTE( "136047-4131.6mn", 0x010001, 0x010000, g.CRC("2ea8a20f") + g.SHA1("927f464e7da540221e341524581cb7bc65e1a31e") ),
            g.ROM_LOAD16_BYTE( "136047-1129.6hj", 0x030000, 0x010000, g.CRC("eabf0b01") + g.SHA1("aaf5ab31b63c6ba414f0d4c95bbbebcceedd1ae4") ),
            g.ROM_LOAD16_BYTE( "136047-1132.6p",  0x030001, 0x010000, g.CRC("a24f333e") + g.SHA1("e4bfa4c670bfb375118d5774f1dbe848e39e6460") ),
            g.ROM_LOAD16_BYTE( "136047-1130.6k",  0x050000, 0x010000, g.CRC("93fba845") + g.SHA1("4de5867272af63be696855f2a4dff99476b213ad") ),
            g.ROM_LOAD16_BYTE( "136047-1133.6r",  0x050001, 0x010000, g.CRC("53c177be") + g.SHA1("a60c81899944e0dda9886e6697edc4d9309ca8f4") ),

            g.ROM_REGION( 0x10000, "audiocpu", 0 ),     // 64k for 6502 code
            g.ROM_LOAD( "136047-2134.2a",  0x004000, 0x004000, g.CRC("0db4ca28") + g.SHA1("71c2e0eee0eee418bdd2f806bd6ce5ae1c72bf69") ),
            g.ROM_LOAD( "136047-1135.2b",  0x008000, 0x004000, g.CRC("b1f157d0") + g.SHA1("26355324d49baa02acb777940d7f49d074a75fe5") ),
            g.ROM_LOAD( "136047-2136.2cd", 0x00c000, 0x004000, g.CRC("00b06bec") + g.SHA1("cd771eea329e0f6ab5bff1035f931800cc5da545") ),

            g.ROM_REGION( 0x40000, "gfx1", 0 ),
            g.ROM_LOAD( "136047-1121.6a",  0x000000, 0x008000, g.CRC("7adb5f9a") + g.SHA1("8b4dba6c7ecd9d1c03c5d87326b5971ad1cb8863") ),
            g.ROM_LOAD( "136047-1122.6b",  0x008000, 0x008000, g.CRC("41b60141") + g.SHA1("a426a0a5f6d4b500571731b3ce5ce8acb5e1db92") ),
            g.ROM_LOAD( "136047-1123.7a",  0x010000, 0x008000, g.CRC("501881d5") + g.SHA1("f38b13774c45eb5b48c87c4410afe4bd311cf3c7") ),
            g.ROM_LOAD( "136047-1124.7b",  0x018000, 0x008000, g.CRC("096f2574") + g.SHA1("6b59ff9a89a93c39c18011a0ac7043457617f336") ),
            g.ROM_LOAD( "136047-1117.6c",  0x020000, 0x008000, g.CRC("5a55f149") + g.SHA1("9dbee28a0bc8ec0d3936d61b7359cb63f4860fff") ),
            g.ROM_LOAD( "136047-1118.6d",  0x028000, 0x008000, g.CRC("9bb2429e") + g.SHA1("80655839e5f53aea19115d83bf395b4f70997edc") ),
            g.ROM_LOAD( "136047-1119.7d",  0x030000, 0x008000, g.CRC("8f7b20e5") + g.SHA1("9f0928a442f63c66350e66b35b1503fe4f9d8e33") ),
            g.ROM_LOAD( "136047-1120.7c",  0x038000, 0x008000, g.CRC("46af6d35") + g.SHA1("c3c2b131245f1231839b3649c117bf5bbace0641") ),

            g.ROM_REGION( 0x100000, "gfx2", g.ROMREGION_INVERT ),
            g.ROM_LOAD( "136047-1109.6t",  0x020000, 0x008000, g.CRC("0a46b693") + g.SHA1("77a743816663a8b8fe6bd9aa2dd0a4e570071068") ),
            g.ROM_CONTINUE(                0x000000, 0x008000 ),
            g.ROM_LOAD( "136047-1110.6sr", 0x028000, 0x008000, g.CRC("457d7e38") + g.SHA1("9ac8e5b49e8f61cb8ce4d739462d17049c966a5d") ),
            g.ROM_CONTINUE(                0x008000, 0x008000 ),
            g.ROM_LOAD( "136047-1111.6p",  0x030000, 0x008000, g.CRC("ffad0a5b") + g.SHA1("127502a256e31c3fca92323544129ec8fcabacb8") ),
            g.ROM_CONTINUE(                0x010000, 0x008000 ),
            g.ROM_LOAD( "136047-1112.6n",  0x038000, 0x008000, g.CRC("06664580") + g.SHA1("2173536af27d9af5b506997a5bbcfd5a40e2023a") ),
            g.ROM_CONTINUE(                0x018000, 0x008000 ),
            g.ROM_LOAD( "136047-1113.6m",  0x060000, 0x008000, g.CRC("7445dc0f") + g.SHA1("cfaa535a4a81a00d0cf47ca3e89625e12abde0f5") ),
            g.ROM_CONTINUE(                0x040000, 0x008000 ),
            g.ROM_LOAD( "136047-1114.6l",  0x068000, 0x008000, g.CRC("23eaceb0") + g.SHA1("8206da45d09b03c51d5c41fdbe964fec0e399837") ),
            g.ROM_CONTINUE(                0x048000, 0x008000 ),
            g.ROM_LOAD( "136047-1115.6kj", 0x070000, 0x008000, g.CRC("0cc8de53") + g.SHA1("656fc4011e6ea362f706048a36e99ff31ecbf7cc") ),
            g.ROM_CONTINUE(                0x050000, 0x008000 ),
            g.ROM_LOAD( "136047-1116.6jh", 0x078000, 0x008000, g.CRC("2d8f1369") + g.SHA1("d35fc5f6733c83d59b0029eb6ee3945e22f0d13b") ),
            g.ROM_CONTINUE(                0x058000, 0x008000 ),
            g.ROM_LOAD( "136047-1101.5t",  0x0a0000, 0x008000, g.CRC("2ac77b80") + g.SHA1("cae6de4ef8a3cf5fb370c0178f734332369e17da") ),
            g.ROM_CONTINUE(                0x080000, 0x008000 ),
            g.ROM_LOAD( "136047-1102.5sr", 0x0a8000, 0x008000, g.CRC("f19c3b06") + g.SHA1("12e2194e5cc9604f02bad03dd6f62bba7f459e73") ),
            g.ROM_CONTINUE(                0x088000, 0x008000 ),
            g.ROM_LOAD( "136047-1103.5p",  0x0b0000, 0x008000, g.CRC("78f9ab90") + g.SHA1("c531e264edaacf61abfbdc8f15b1b47e85a4cdf0") ),
            g.ROM_CONTINUE(                0x090000, 0x008000 ),
            g.ROM_LOAD( "136047-1104.5n",  0x0b8000, 0x008000, g.CRC("77ce4a7f") + g.SHA1("5c4a6fb01bd744f17cbacc3087c4bdb5e3bfe475") ),
            g.ROM_CONTINUE(                0x098000, 0x008000 ),
            g.ROM_LOAD( "136047-1105.5m",  0x0e0000, 0x008000, g.CRC("bef5a025") + g.SHA1("5cfe82f1ef2dd95cc5fa317bd59f69c4cd69fdd2") ),
            g.ROM_CONTINUE(                0x0c0000, 0x008000 ),
            g.ROM_LOAD( "136047-1106.5l",  0x0e8000, 0x008000, g.CRC("92a159c8") + g.SHA1("bc4f06eb666967ac726b7f85719d2fcd74e3b573") ),
            g.ROM_CONTINUE(                0x0c8000, 0x008000 ),
            g.ROM_LOAD( "136047-1107.5kj", 0x0f0000, 0x008000, g.CRC("0a94a3ef") + g.SHA1("7dec8c768d0673ab3c8211f19b17674531dda308") ),
            g.ROM_CONTINUE(                0x0d0000, 0x008000 ),
            g.ROM_LOAD( "136047-1108.5jh", 0x0f8000, 0x008000, g.CRC("9815eda6") + g.SHA1("89a80c67f4b3426e7516cd1179d5712779ef5db7") ),
            g.ROM_CONTINUE(                0x0d8000, 0x008000 ),

            g.ROM_REGION( 0x4000, "gfx3", 0 ),
            g.ROM_LOAD( "136047-1125.4t",  0x000000, 0x004000, g.CRC("6b7e2328") + g.SHA1("cc9a315ccafe7228951b7c32cf3b31caa89ae7d3") ),

            g.ROM_REGION( 0x200, "eeprom", 0 ),
            g.ROM_LOAD( "720-eeprom.bin", 0x0000, 0x0200, g.CRC("cfe1c24e") + g.SHA1("5f7623b0a2ff0d99ffa8e6420a5bc03e0c55250d") ),
            g.ROM_END,
        };
    ...
    partial class atarisy2 : construct_ioport_helper
    {
        ...
        public static readonly game_driver driver_paperboy = g.GAME( device_creator_paperboy, rom_paperboy, "1984", "paperboy", "0",    atarisy2_state_paperboy, m_atarisy2.construct_ioport_paperboy, atarisy2_state_init_paperboy, g.ROT0, "Atari Games", "Paperboy (rev 3)", g.MACHINE_SUPPORTS_SAVE );
        ...
        //                                                      creator,            rom      YEAR,   NAME,  PARENT, MACHINE,             INPUT,                           INIT,                    MONITOR,COMPANY,       FULLNAME,              FLAGS
        public static readonly game_driver driver_720 = g.GAME( device_creator_720, rom_720, "1986", "720", "0",    atarisy2_state__720, m_atarisy2.construct_ioport_720, atarisy2_state_init_720, g.ROT0, "Atari Games", "720 Degrees (rev 4)", g.MACHINE_SUPPORTS_SAVE );
