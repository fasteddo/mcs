...
namespace mame
{
    partial class dkong_state : driver_device
    {
        ...
        {
            address_space prog_space = m_maincpu.op[0].memory().space(g.AS_PROGRAM);
        ...
        void machine_start_dkong2b()
        {
            ...
            save_item(g.NAME(new { m_decrypt_counter }));
            save_item(g.NAME(new { m_dma_latch }));
        }
    ...
    partial class dkong : construct_ioport_helper
    {
        ...
        void construct_ioport_dkong_in0_4(device_t owner, ioport_list portlist, ref string errorbuf)
        {
            ...
            PORT_START("IN0");      /* IN0 */
            PORT_BIT( 0x01, g.IP_ACTIVE_HIGH, g.IPT_JOYSTICK_RIGHT ); PORT_4WAY();
            PORT_BIT( 0x02, g.IP_ACTIVE_HIGH, g.IPT_JOYSTICK_LEFT ); PORT_4WAY();
            PORT_BIT( 0x04, g.IP_ACTIVE_HIGH, g.IPT_JOYSTICK_UP ); PORT_4WAY();
            PORT_BIT( 0x08, g.IP_ACTIVE_HIGH, g.IPT_JOYSTICK_DOWN ); PORT_4WAY();
            PORT_BIT( 0x10, g.IP_ACTIVE_HIGH, g.IPT_BUTTON1 );
            PORT_BIT( 0x20, g.IP_ACTIVE_HIGH, g.IPT_UNKNOWN ); /* not connected - held to high */
            PORT_BIT( 0x40, g.IP_ACTIVE_HIGH, g.IPT_UNKNOWN ); /* not connected - held to high */
            PORT_BIT( 0x80, g.IP_ACTIVE_HIGH, g.IPT_UNKNOWN ); /* not connected - held to high */
        ...
        void construct_ioport_dkong_in1_4(device_t owner, ioport_list portlist, ref string errorbuf)
        {
            ...
            PORT_START("IN1");      /* IN1 */
            PORT_BIT( 0x01, g.IP_ACTIVE_HIGH, g.IPT_JOYSTICK_RIGHT ); PORT_4WAY(); PORT_COCKTAIL();
            PORT_BIT( 0x02, g.IP_ACTIVE_HIGH, g.IPT_JOYSTICK_LEFT ); PORT_4WAY(); PORT_COCKTAIL();
            PORT_BIT( 0x04, g.IP_ACTIVE_HIGH, g.IPT_JOYSTICK_UP ); PORT_4WAY(); PORT_COCKTAIL();
            PORT_BIT( 0x08, g.IP_ACTIVE_HIGH, g.IPT_JOYSTICK_DOWN ); PORT_4WAY(); PORT_COCKTAIL();
        ...
        void construct_ioport_dkong_in2(device_t owner, ioport_list portlist, ref string errorbuf)
        {
             ...
             */
            PORT_START("IN2");      /* IN2 */
            PORT_BIT( 0x01, g.IP_ACTIVE_HIGH, g.IPT_SERVICE ); /* connection not labeled in schematics - diagnostic rom */
            PORT_BIT( 0x02, g.IP_ACTIVE_HIGH, g.IPT_UNKNOWN ); /* connection not labeled in schematics - freeze or reset */
            PORT_BIT( 0x04, g.IP_ACTIVE_HIGH, g.IPT_START1 );
            PORT_BIT( 0x08, g.IP_ACTIVE_HIGH, g.IPT_START2 );
            PORT_BIT( 0x10, g.IP_ACTIVE_HIGH, g.IPT_UNKNOWN );   /* not connected - held to high */
            PORT_BIT( 0x20, g.IP_ACTIVE_HIGH, g.IPT_UNKNOWN );   /* not connected - held to high */
            PORT_BIT( 0x40, g.IP_ACTIVE_HIGH, g.IPT_CUSTOM ); PORT_READ_LINE_DEVICE_MEMBER("virtual_p2", () => { return ((latch8_device)dkong_state.subdevice("virtual_p2")).bit4_q_r(); });  //latch8_device, bit4_q_r) /* status from sound cpu */
            PORT_BIT( 0x80, g.IP_ACTIVE_HIGH, g.IPT_COIN1 );

            PORT_START("SERVICE1");
            PORT_BIT( 0x01, g.IP_ACTIVE_HIGH, g.IPT_SERVICE1 );
        ...
        void construct_ioport_dkong_dsw0(device_t owner, ioport_list portlist, ref string errorbuf)
        {
            ...
            PORT_DIPNAME( 0x03, 0x00, g.DEF_STR( g.Lives ) );        PORT_DIPLOCATION( "SW1:!1,!2" );
            PORT_DIPSETTING(    0x00, "3" );
            PORT_DIPSETTING(    0x01, "4" );
            PORT_DIPSETTING(    0x02, "5" );
            PORT_DIPSETTING(    0x03, "6" );
            PORT_DIPNAME( 0x0c, 0x00, g.DEF_STR( g.Bonus_Life ) );   PORT_DIPLOCATION( "SW1:!3,!4" );
            PORT_DIPSETTING(    0x00, "7000" );
            PORT_DIPSETTING(    0x04, "10000" );
            PORT_DIPSETTING(    0x08, "15000" );
            PORT_DIPSETTING(    0x0c, "20000" );
            PORT_DIPNAME( 0x70, 0x00, g.DEF_STR( g.Coinage ) );      PORT_DIPLOCATION( "SW1:!5,!6,!7" );
            PORT_DIPSETTING(    0x70, g.DEF_STR( g._5C_1C ) );
            PORT_DIPSETTING(    0x50, g.DEF_STR( g._4C_1C ) );
            PORT_DIPSETTING(    0x30, g.DEF_STR( g._3C_1C ) );
            PORT_DIPSETTING(    0x10, g.DEF_STR( g._2C_1C ) );
            PORT_DIPSETTING(    0x00, g.DEF_STR( g._1C_1C ) );
            PORT_DIPSETTING(    0x20, g.DEF_STR( g._1C_2C ) );
            PORT_DIPSETTING(    0x40, g.DEF_STR( g._1C_3C ) );
            PORT_DIPSETTING(    0x60, g.DEF_STR( g._1C_4C ) );
            PORT_DIPNAME( 0x80, 0x80, g.DEF_STR( g.Cabinet ) );      PORT_DIPLOCATION( "SW1:!8" );
    ...
    partial class dkong_state : driver_device
    {
        ...
        void dkong_base(machine_config config)
        {
            ...
            g.Z80(config, m_maincpu, CLOCK_1H);
            m_maincpu.op[0].memory().set_addrmap(g.AS_PROGRAM, dkong_map);

            g.MCFG_MACHINE_START_OVERRIDE(config, machine_start_dkong2b);
            g.MCFG_MACHINE_RESET_OVERRIDE(config, machine_reset_dkong);

            g.I8257(config, m_dma8257, CLOCK_1H);
            ...
            g.GFXDECODE(config, m_gfxdecode, m_palette, gfx_dkong);
            g.PALETTE(config, m_palette, dkong2b_palette, DK2B_PALETTE_LENGTH);

            g.MCFG_VIDEO_START_OVERRIDE(config, video_start_dkong);
        }
    ...
    partial class dkong : construct_ioport_helper
    {
        ...
        static readonly MemoryContainer<tiny_rom_entry> rom_dkong = new MemoryContainer<tiny_rom_entry>()
        {
            ...
            g.ROM_LOAD( "c_5et_g.bin",  0x0000, 0x1000, g.CRC("ba70b88b") + g.SHA1("d76ebecfea1af098d843ee7e578e480cd658ac1a") ),
            g.ROM_LOAD( "c_5ct_g.bin",  0x1000, 0x1000, g.CRC("5ec461ec") + g.SHA1("acb11a8fbdbb3ab46068385fe465f681e3c824bd") ),
            g.ROM_LOAD( "c_5bt_g.bin",  0x2000, 0x1000, g.CRC("1c97d324") + g.SHA1("c7966261f3a1d3296927e0b6ee1c58039fc53c1f") ),
            g.ROM_LOAD( "c_5at_g.bin",  0x3000, 0x1000, g.CRC("b9005ac0") + g.SHA1("3fe3599f6fa7c496f782053ddf7bacb453d197c4") ),

            g.ROM_REGION( 0x1800, "soundcpu", 0 ), /* sound */
            g.ROM_LOAD( "s_3i_b.bin",   0x0000, 0x0800, g.CRC("45a4ed06") + g.SHA1("144d24464c1f9f01894eb12f846952290e6e32ef") ),
            g.ROM_RELOAD(               0x0800, 0x0800 ),
            g.ROM_LOAD( "s_3j_b.bin",   0x1000, 0x0800, g.CRC("4743fe92") + g.SHA1("6c82b57637c0212a580591397e6a5a1718f19fd2") ),

            g.ROM_REGION( 0x1000, "gfx1", 0 ),
            g.ROM_LOAD( "v_5h_b.bin",   0x0000, 0x0800, g.CRC("12c8c95d") + g.SHA1("a57ff5a231c45252a63b354137c920a1379b70a3") ),
            g.ROM_LOAD( "v_3pt.bin",    0x0800, 0x0800, g.CRC("15e9c5e9") + g.SHA1("976eb1e18c74018193a35aa86cff482ebfc5cc4e") ),

            g.ROM_REGION( 0x2000, "gfx2", 0 ),
            g.ROM_LOAD( "l_4m_b.bin",   0x0000, 0x0800, g.CRC("59f8054d") + g.SHA1("793dba9bf5a5fe76328acdfb90815c243d2a65f1") ),
            g.ROM_LOAD( "l_4n_b.bin",   0x0800, 0x0800, g.CRC("672e4714") + g.SHA1("92e5d379f4838ac1fa44d448ce7d142dae42102f") ),
            g.ROM_LOAD( "l_4r_b.bin",   0x1000, 0x0800, g.CRC("feaa59ee") + g.SHA1("ecf95db5a20098804fc8bd59232c66e2e0ed3db4") ),
            g.ROM_LOAD( "l_4s_b.bin",   0x1800, 0x0800, g.CRC("20f2ef7e") + g.SHA1("3bc482a38bf579033f50082748ee95205b0f673d") ),

            g.ROM_REGION( 0x0300, "proms", 0 ),
            g.ROM_LOAD( "c-2k.bpr",     0x0000, 0x0100, g.CRC("e273ede5") + g.SHA1("b50ec9e1837c00c20fb2a4369ec7dd0358321127") ), /* palette low 4 bits (inverted) */
            g.ROM_LOAD( "c-2j.bpr",     0x0100, 0x0100, g.CRC("d6412358") + g.SHA1("f9c872da2fe8e800574ae3bf483fb3ccacc92eb3") ), /* palette high 4 bits (inverted) */
            g.ROM_LOAD( "v-5e.bpr",     0x0200, 0x0100, g.CRC("b869b8f5") + g.SHA1("c2bdccbf2654b64ea55cd589fd21323a9178a660") ), /* character color codes on a per-column basis */
        ...
        public static readonly game_driver driver_dkong = g.GAME( device_creator_dkong, rom_dkong, "1981", "dkong",    "0",     dkong_state_dkong2b, m_dkong.construct_ioport_dkong, driver_device.empty_init,  g.ROT270, "Nintendo of America", "Donkey Kong (US set 1)", g.MACHINE_SUPPORTS_SAVE );
    }
}
