...
namespace mame
{
        ...
        where endianness_t_Endian : endianness_t_constant, new()
    {
        ...
        class handler_array : std.array<handler_entry_read<int_Width, int_AddrShift, endianness_t_Endian>, uint32_constant_COUNT>
        {
        ...
        {
            return emumem_global.dispatch_read<int_constant_Level, int_Width, int_AddrShift, endianness_t_Endian>(HIGHMASK, offset, mem_mask, m_a_dispatch);
        }
        ...
        void range_cut_before(offs_t address, int start)  // = COUNT)
        {
            while (--start >= 0 && m_u_dispatch[start] != null)
            {
                ...
                {
                    ((handler_entry_read_dispatch<int_constant_LowBits, int_Width, int_AddrShift, endianness_t_Endian>)m_u_dispatch[start]).range_cut_before(address);  //static_cast<handler_entry_read_dispatch<LowBits, Width, AddrShift, Endian> *>(m_dispatch[start]).range_cut_before(address);
                    break;
                }
        ...
        void range_cut_after(offs_t address, int start = -1)
        {
            while (++start < COUNT && m_u_dispatch[start] != null)
            {
                if ((int)LowBits > -AddrShift && m_u_dispatch[start].is_dispatch())
                {
                    ((handler_entry_read_dispatch<int_constant_LowBits, int_Width, int_AddrShift, endianness_t_Endian>)m_u_dispatch[start]).range_cut_after(address);  //static_cast<handler_entry_read_dispatch<LowBits, Width, AddrShift, Endian> *>(m_dispatch[start]).range_cut_after(address);
                    break;
                }
        ...
        void populate_nomirror_subdispatch(offs_t entry, offs_t start, offs_t end, offs_t ostart, offs_t oend, handler_entry_read<int_Width, int_AddrShift, endianness_t_Endian> handler)
        {
            ...
            {
                var subdispatch = new handler_entry_read_dispatch<int_constant_LowBits, int_Width, int_AddrShift, endianness_t_Endian>(m_space, m_u_ranges[entry], cur);  //auto subdispatch = new handler_entry_read_dispatch<LowBits, Width, AddrShift, Endian>(handler_entry::m_space, m_ranges[entry], cur);
                cur.unref();
        ...
        void populate_mirror_subdispatch(offs_t entry, offs_t start, offs_t end, offs_t ostart, offs_t oend, offs_t mirror, handler_entry_read<int_Width, int_AddrShift, endianness_t_Endian> handler)
        {
            ...
            {
                var subdispatch = new handler_entry_read_dispatch<int_constant_LowBits, int_Width, int_AddrShift, endianness_t_Endian>(m_space, m_u_ranges[entry], cur);  //auto subdispatch = new handler_entry_read_dispatch<LowBits, Width, AddrShift, Endian>(handler_entry::m_space, m_u_ranges[entry], cur);
                cur.unref();
                m_u_dispatch[entry] = subdispatch;
