...
namespace mame
{
    public static class inpttype_global
    {
        ...
        static void construct_core_types_P2(simple_list<input_type_entry> typelist)
        {
            ...
            INPUT_PORT_DIGITAL_TYPE(typelist, 2, ioport_group.IPG_PLAYER2, ioport_type.IPT_BUTTON5,             "P2 Button 5",            new input_seq(input_global.KEYCODE_E, input_seq.or_code, input_global.JOYCODE_BUTTON5_INDEXED(1)) );
