...
namespace mame
{
    ...
    public static class object_finder_operations_helper
    {
        // see src\mame\object_finder_operations.cs
        public static Func<Type, object> get_object_finder_operations;
    }
        ...
        where bool_Required : bool_const, new()
    {
        ...
        public override bool findit(validity_checker valid)
        {
            ...
            else if (typeof(DeviceClass) == typeof(device_palette_interface) && device is palette_device palette_device)
                this.m_target = new Pointer<DeviceClass>(new MemoryContainer<DeviceClass>() { ops.cast(palette_device.dipalette) });  //this->m_target = dynamic_cast<DeviceClass *>(device);
            else
    ...
    /// address map.
    public class memory_bank_creator : finder_base
    {
    ...
    public class region_ptr_finder<PointerType, bool_Required> : object_finder_base<PointerType, bool_Required>  //class region_ptr_finder : public object_finder_base<PointerType, Required>
        where bool_Required : bool_const, new()
    {
        /// \brief Region length
        ///
    ...
    public class region_ptr_finder_u16<bool_Required> : region_ptr_finder<uint8_t, bool_Required>  //class region_ptr_finder : public object_finder_base<PointerType, Required>
        where bool_Required : bool_const, new()
    {
    ...
    public class optional_region_ptr<PointerType> : region_ptr_finder<PointerType, bool_const_false>
    {
    ...
    public class required_region_ptr<PointerType> : region_ptr_finder<PointerType, bool_const_true>
    {
    ...
    public class required_shared_ptr<PointerType> : shared_ptr_finder<PointerType, bool_const_true>
    {
    ...
    public class memory_share_creator<PointerType> : finder_base  //class memory_share_creator : public finder_base
    {
        /// \brief Pointer to target object
        ///
