...
namespace mame
{
    ...
    namespace emu.detail
    {
        ...
        public class device_type_impl_base
        {
            ...
            device_type_impl_base m_parent_rom;
            ...
            public device_type_impl_base(device_tag_struct device_tag)
            {
                ...
                m_unemulated_features = device_tag.DeviceClass_unemulated_features;  //m_unemulated_features(DeviceClass::unemulated_features())
                m_imperfect_features = device_tag.DeviceClass_imperfect_features;  //m_imperfect_features(DeviceClass::imperfect_features())
                m_parent_rom = device_tag.DeviceClass_parent_rom_device_type;  //m_parent_rom(DeviceClass::parent_rom_device_type())
            ...
            public device_type_impl_base(driver_tag_struct driver_tag)
            {
                ...
                m_unemulated_features = driver_tag.DriverClass_unemulated_features | driver_tag.Unemulated;  //m_unemulated_features(DriverClass::unemulated_features() | Unemulated)
                m_imperfect_features = (driver_tag.DriverClass_imperfect_features & ~driver_tag.Unemulated) | driver_tag.Imperfect;  //m_imperfect_features((DriverClass::imperfect_features() & ~Unemulated) | Imperfect)
                m_parent_rom = driver_tag.DriverClass_parent_rom_device_type;  //m_parent_rom(DriverClass::parent_rom_device_type())
                m_next = null;
            }
            ...
            public device_type_impl_base parent_rom_device_type() { return m_parent_rom; }

            public device_t create(machine_config mconfig, string tag, device_t owner, u32 clock) { return m_creator(this, mconfig, tag, owner, clock); }
                                     ...
                                     netlist.detail.netlist_name_interface
    {
        ...
        public static device_type parent_rom_device_type() { return null; }  //static auto parent_rom_device_type() { return nullptr; }
        ...
        public virtual std.vector<string> searchpath()
        {
            ...
            if (type().parent_rom_device_type() != null)
                result.emplace(0, type().parent_rom_device_type().shortname());  //result.emplace(result.begin(), type().parent_rom_device_type()->shortname());
