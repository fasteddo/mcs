...
namespace mame
{
    ...
    class handler_entry_read_delegate : handler_entry_read_address
    {
        ...
        public handler_entry_read_delegate(int Width, int AddrShift, int Endian, address_space space, object /*READ*/ delegate_) : base(Width, AddrShift, Endian, space, 0)
        {
        ...
        uX read_impl(read8_delegate delegate_, int WidthOverride, int AddrShiftOverride, int EndianOverride, offs_t offset, uX mem_mask)
        {
        ...
        uX read_impl(read16_delegate delegate_, int WidthOverride, int AddrShiftOverride, int EndianOverride, offs_t offset, uX mem_mask)
        {
            //return m_delegate(*inh::m_space, ((offset - inh::m_address_base) & inh::m_address_mask) >> (Width + AddrShift), mem_mask);
        ...
        //                     uX> read_impl(offs_t offset, uX mem_mask);
        uX read_impl(read16s_delegate delegate_, int WidthOverride, int AddrShiftOverride, int EndianOverride, offs_t offset, uX mem_mask)
        {
        ...
        //                     uX> read_impl(offs_t offset, uX mem_mask);
        uX read_impl(read8sm_delegate delegate_, int WidthOverride, int AddrShiftOverride, int EndianOverride, offs_t offset, uX mem_mask)
        {
        ...
        //                     uX> read_impl(offs_t offset, uX mem_mask);
        uX read_impl(read8smo_delegate delegate_, int WidthOverride, int AddrShiftOverride, int EndianOverride, offs_t offset, uX mem_mask)
        {
            //return m_delegate();
    ...
    class handler_entry_write_delegate : handler_entry_write_address
    {
        ...
        public handler_entry_write_delegate(int Width, int AddrShift, int Endian, address_space space, object /*WRITE*/ delegate_) : base(Width, AddrShift, Endian, space, 0)
        {
        ...
        void write_impl(write8_delegate delegate_, int WidthOverride, int AddrShiftOverride, int EndianOverride, offs_t offset, uX data, uX mem_mask)
        {
        ...
        void write_impl(write16_delegate delegate_, int WidthOverride, int AddrShiftOverride, int EndianOverride, offs_t offset, uX data, uX mem_mask)
        {
        ...
        //                     void> write_impl(offs_t offset, uX data, uX mem_mask);
        void write_impl(write16s_delegate delegate_, int WidthOverride, int AddrShiftOverride, int EndianOverride, offs_t offset, uX data, uX mem_mask)
        {
        ...
        //                     void> write_impl(offs_t offset, uX data, uX mem_mask);
        void write_impl(write8sm_delegate delegate_, int WidthOverride, int AddrShiftOverride, int EndianOverride, offs_t offset, uX data, uX mem_mask)
        {
        ...
        //                     void> write_impl(offs_t offset, uX data, uX mem_mask);
        void write_impl(write8smo_delegate delegate_, int WidthOverride, int AddrShiftOverride, int EndianOverride, offs_t offset, uX data, uX mem_mask)
        {
            m_delegate8smo(data.x8);  //m_delegate(data);
        }

        void write_impl(write16smo_delegate delegate_, int WidthOverride, int AddrShiftOverride, int EndianOverride, offs_t offset, uX data, uX mem_mask)
        {
