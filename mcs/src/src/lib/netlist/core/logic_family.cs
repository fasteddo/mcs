...
namespace mame.netlist
{
    ...
    {
        public nl_fptype m_low_threshold_PCNT;   //!< low input threshhold offset. If the input voltage is below this value times supply voltage, a "0" input is signalled
        public nl_fptype m_high_threshold_PCNT;  //!< high input threshhold offset. If the input voltage is above the value times supply voltage, a "0" input is signalled
        ...
        nl_fptype low_threshold_V(nl_fptype VN, nl_fptype VP) { return VN + (VP - VN) * m_low_threshold_PCNT; }
        nl_fptype high_threshold_V(nl_fptype VN, nl_fptype VP) { return VN + (VP - VN) * m_high_threshold_PCNT; }
        ...
        public bool is_above_high_threshold_V(nl_fptype V, nl_fptype VN, nl_fptype VP)
        { return V > high_threshold_V(VN, VP); }

        public bool is_below_low_threshold_V(nl_fptype V, nl_fptype VN, nl_fptype VP)
