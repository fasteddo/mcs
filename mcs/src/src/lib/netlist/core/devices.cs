...
namespace mame.netlist.devices
{
    ...
    class nld_mainclock : device_t  //NETLIB_OBJECT(mainclock)
    {
        ...
        public nld_mainclock(object owner, string name)  //NETLIB_CONSTRUCTOR(mainclock)
            : base(owner, name)
        {
    ...
    class nld_power_pins
    {
        ...
        public nld_power_pins(device_t owner, nldelegate delegate_)
        {
        ...
        // Some devices like the 74LS629 have two pairs of supply pins.
        public nld_power_pins(device_t owner, string vcc, string gnd, nldelegate delegate_)
        {
    ...
    public class nld_netlistparams : device_t  //NETLIB_OBJECT(netlistparams)
    {
        ...
        public nld_netlistparams(object owner, string name)  //NETLIB_CONSTRUCTOR(netlistparams)
            : base(owner, name)
        {
    ...
    class nld_nc_pin : device_t  //NETLIB_OBJECT(nc_pin)
    {
        ...
        nld_nc_pin(object owner, string name)  //NETLIB_CONSTRUCTOR(nc_pin)
            : base(owner, name)
        {
