...
namespace mame
{
    public static class nlm_base_global
    {
        ...
        public static void netlist_diode_models(netlist.nlparse_t setup)
        {
            ...
            netlist.nl_setup_global.NET_MODEL(setup, "1N916 D(Is=2.52n Rs=.568 N=1.752 Cjo=4p M=.4 tt=20n Iave=200m Vpk=75 mfg=OnSemi type=silicon)");
            ...
            netlist.nl_setup_global.NET_MODEL(setup, "1N4002 D(IS=65.4p RS=42.2m BV=100 IBV=5.00u CJO=14.8p M=0.333 N=1.36 TT=2.88u)");
            ...
            netlist.nl_setup_global.NET_MODEL(setup, "1N4154 D(Is=0.1n Rs=4 N=1.67 Cjo=2p M=.333 tt=3n Iave=150m Vpk=35 Bv=60 Ibv=0.1p mfg=Vishay type=silicon)");
            netlist.nl_setup_global.NET_MODEL(setup, "1N4454 D(Is=168.1e-21 Rs=.1 N=1 Cjo=2p M=.333 tt=5.771n Iave=400m Vpk=35 Bv=75 Ibv=100u mfg=OnSemi type=silicon)");
            ...
            netlist.nl_setup_global.NET_MODEL(setup, "1N5231  D(BV=5.1 IBV=0.020 NBV=1)");
            netlist.nl_setup_global.NET_MODEL(setup, "1N5236B D(BV=7.5 IS=27.5p RS=33.8 N=1.10 CJO=58.2p VJ=0.750 M=0.330 TT=50.1n)");
            netlist.nl_setup_global.NET_MODEL(setup, "1N5240  D(BV=10 IS=14.4p RS=32.0 N=1.10 CJO=24.1p VJ=0.750 M=0.330 TT=50.1n)");
            netlist.nl_setup_global.NET_MODEL(setup, "1N5240B D(BV=10 IS=14.4p RS=32.0 N=1.10 CJO=24.1p VJ=0.750 M=0.330 TT=50.1n)");
        ...
        public static void netlist_bjt_models(netlist.nlparse_t setup)
        {
            ...
            netlist.nl_setup_global.NET_MODEL(setup, "NPN _(IS=1e-15 BF=100 NF=1 BR=1 NR=1 CJE=0 CJC=0)");
            netlist.nl_setup_global.NET_MODEL(setup, "PNP _(IS=1e-15 BF=100 NF=1 BR=1 NR=1 CJE=0 CJC=0)");
            ...
            netlist.nl_setup_global.NET_MODEL(setup, "2N3702 PNP(Is=650.6E-18 Xti=3 Eg=1.11 Vaf=115.7 Bf=133.8 Ne=1.832 Ise=97.16f Ikf=1.081 Xtb=1.5 Br=3.73 Nc=2 Isc=0 Ikr=0 Rc=.715 Cjc=14.76p Mjc=.5383 Vjc=.75 Fc=.5 Cje=19.82p Mje=.3357 Vje=.75 Tr=114.1n Tf=761.3p Itf=.65 Vtf=5 Xtf=1.7 Rb=10 mfg=National)");
            netlist.nl_setup_global.NET_MODEL(setup, "2N3704 NPN(IS=26.03f VAF=90.7 Bf=736.1K IKF=.1983 XTB=1.5 BR=1.024 CJC=11.01p CJE=24.07p RB=10 RC=.5 RE=.5 TR=233.8n TF=1.03n ITF=0 VTF=0 XTF=0 mfg=Motorola)");
            // SPICE model parameters taken from Fairchild Semiconductor datasheet
            netlist.nl_setup_global.NET_MODEL(setup, "2N3904 NPN(IS=1E-14 VAF=100 Bf=300 IKF=0.4 XTB=1.5 BR=4 CJC=4E-12 CJE=8E-12 RB=20 RC=0.1 RE=0.1 TR=250E-9 TF=350E-12 ITF=1 VTF=2 XTF=3 Vceo=40 Icrating=200m mfg=Philips)");
            // SPICE model parameters taken from Fairchild Semiconductor datasheet
            netlist.nl_setup_global.NET_MODEL(setup, "2N3906 PNP(Is=1.41f Xti=3 Eg=1.11 Vaf=18.7 Bf=180.7 Ne=1.5 Ise=0 Ikf=80m Xtb=1.5 Br=4.977 Nc=2 Isc=0 Ikr=0 Rc=2.5 Cjc=9.728p Mjc=.5776 Vjc=.75 Fc=.5 Cje=8.063p Mje=.3677 Vje=.75 Tr=33.42n Tf=179.3p Itf=.4 Vtf=4 Xtf=6 Rb=10)");
            // 2N5190 = BC817-25
            ...
            netlist.nl_setup_global.NET_MODEL(setup, "2N4403 PNP(Is=650.6E-18 Xti=3 Eg=1.11 Vaf=115.7 Bf=216.2 Ne=1.829 Ise=58.72f Ikf=1.079 Xtb=1.5 Br=3.578 Nc=2 Isc=0 Ikr=0 Rc=.715 Cjc=14.76p Mjc=.5383 Vjc=.75 Fc=.5 Cje=19.82p Mje=.3357 Vje=.75 Tr=111.6n Tf=603.7p Itf=.65 Vtf=5 Xtf=1.7 Rb=10)");
            netlist.nl_setup_global.NET_MODEL(setup, "2N4124 NPN(IS=6.734f XTI=3 EG=1.11 VAF=74.03 BF=495 NE=1.28 ISE=6.734f IKF=69.35m XTB=1.5 BR=0.7214 NC=2 ISC=0 IKR=0 RC=1 CJC=3.638p MJC=0.3085 VJC=0.75 FC=0.5 CJE=4.493p MJE=0.2593 VJE=0.75 TR=238.3n TF=301.3p ITF=.4 VTF=4 XTF=2 RB=10 VCEO=25)");
            netlist.nl_setup_global.NET_MODEL(setup, "2N4126 PNP(IS=1.41f XTI=3 EG=1.11 VAF=18.7 BF=203.7 NE=1.5 ISE=0 IKF=80m XTB=1.5 BR=4.924 NC=2 ISC=0 IKR=0 RC=2.5 CJC=9.728p MJC=0.5776 VJC=0.75 FC=0.5 CJE=8.063p MJE=0.3677 VJE=0.75 TR=33.23n TF=179.3p ITF=.4 VTF=4 XTF=6 RB=10 VCEO=25)");
            // SPICE model parameters taken from http://ltwiki.org/files/LTspiceIV/Vendor%20List/Fairchild/2N/index.html
            netlist.nl_setup_global.NET_MODEL(setup, "2N5210 NPN(Is=5.911f Xti=3 Eg=1.11 Vaf=62.37 Bf=809.9 Ne=1.358 Ise=5.911f Ikf=14.26m Xtb=1.5 Br=1.287 Nc=2 Isc=0 Ikr=0 Rc=1.61 Cjc=4.017p Mjc=.3174 Vjc=.75 Fc=.5 Cje=4.973p Mje=.4146 Vje=.75 Tr=4.68n Tf=820.9p Itf=.35 Vtf=4 Xtf=7 Rb=10)");
            // SPICE model parameters taken from https://www.onsemi.com/support/design-resources/models?rpn=2N6107
            netlist.nl_setup_global.NET_MODEL(setup, "2N6107 PNP(IS=7.62308e-14 BF=6692.56 NF=0.85 VAF=10 IKF=0.032192 ISE=2.07832e-13 NE=2.41828 BR=15.6629 NR=1.5 VAR=1.44572 IKR=0.32192 ISC=4.75e-16 NC=3.9375 RB=7.19824 IRB=0.1 RBM=0.1 RE=0.0001 RC=0.355458 XTB=0.1 XTI=2.97595 EG=1.206 CJE=1.84157e-10 VJE=0.99 MJE=0.347177 TF=6.63757e-09 XTF=1.50003 VTF=1.0001 ITF=1 CJC=1.06717e-10 VJC=0.942679 MJC=0.245405 XCJC=0.8 FC=0.533334 CJS=0 VJS=0.75 MJS=0.5 TR=1.32755e-07 PTF=0 KF=0 AF=1)");
            // SPICE model parameters taken from https://www.onsemi.com/support/design-resources/models?rpn=2N6292
            netlist.nl_setup_global.NET_MODEL(setup, "2N6292 NPN(IS=9.3092e-13 BF=2021.8 NF=0.85 VAF=63.2399 IKF=1 ISE=1.92869e-13 NE=1.97024 BR=40.0703 NR=1.5 VAR=0.89955 IKR=10 ISC=4.92338e-16 NC=3.9992 RB=6.98677 IRB=0.1 RBM=0.1 RE=0.0001 RC=0.326141 XTB=0.1 XTI=2.86739 EG=1.206 CJE=1.84157e-10 VJE=0.99 MJE=0.347174 TF=6.73756e-09 XTF=1.49917 VTF=0.997395 ITF=0.998426 CJC=1.06717e-10 VJC=0.942694 MJC=0.245406 XCJC=0.8 FC=0.533405 CJS=0 VJS=0.75 MJS=0.5 TR=6.0671e-08 PTF=0 KF=0 AF=1)");
            ...
            netlist.nl_setup_global.NET_MODEL(setup, "9013 NPN(IS=3.40675E-14 BF=166 VAF=67 IKF=1.164 ISE=12.37e-15 NE=2 BR=15.17 VAR=40.84 IKR=0.261352 ISC=1.905E-15 NC=1.066 RB=63.2 IRB=5.62E-6 RBM=22.1 RE=0.02 RC=0.7426 CJE=3.53E-11 VJE=0.808 MJE=0.372 CJC=1.74E-11 VJC=0.614 MJC=0.388 XCJC=0.349 XTB=1.4025 EG=1.0999 XTI=3 VC=0.5 VCEO=20)");
        ...
        public static void netlist_base_lib(netlist.nlparse_t setup)
        {
            ...
            netlist.nl_setup_global.EXTERNAL_SOURCE(setup, "ttl74xx_lib", nlm_ttl74xx_global.netlist_ttl74xx_lib);
            netlist.nl_setup_global.EXTERNAL_SOURCE(setup, "cd4xxx_lib", nlm_cd4xxx_global.netlist_cd4xxx_lib);
            netlist.nl_setup_global.EXTERNAL_SOURCE(setup, "opamp_lib", nlm_opamp_global.netlist_opamp_lib);
            netlist.nl_setup_global.EXTERNAL_SOURCE(setup, "otheric_lib", nlm_other_global.netlist_otheric_lib);
            netlist.nl_setup_global.EXTERNAL_SOURCE(setup, "roms_lib", nlm_roms_global.netlist_roms_lib);

            throw new emu_unimplemented();
#if false
            netlist.nl_setup_global.EXTERNAL_SOURCE(setup, "modules_lib", netlist_modules_lib);
#endif
            ...
            netlist.nl_setup_global.INCLUDE(setup, "modules_lib");
