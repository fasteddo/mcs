...
namespace mame
{
    public class osd_options : emu_options
    {
        ...
        {
            new options_entry(null,                                   null,              core_options.option_type.HEADER,    "OSD KEYBOARD MAPPING OPTIONS"),
            ...
            new options_entry(font_module.OSD_FONT_PROVIDER,          OSDOPTVAL_AUTO,    core_options.option_type.STRING,    "provider for UI font: "),

            new options_entry(null,                                   null,              core_options.option_type.HEADER,    "OSD OUTPUT OPTIONS"),
            new options_entry(output_module.OSD_OUTPUT_PROVIDER,      OSDOPTVAL_AUTO,    core_options.option_type.STRING,    "provider for output notifications: "),

            new options_entry(null,                                   null,              core_options.option_type.HEADER,    "OSD INPUT OPTIONS"),
            new options_entry(input_module.OSD_KEYBOARDINPUT_PROVIDER, OSDOPTVAL_AUTO,   core_options.option_type.STRING,    "provider for keyboard input: "),
            new options_entry(input_module.OSD_MOUSEINPUT_PROVIDER,   OSDOPTVAL_AUTO,    core_options.option_type.STRING,    "provider for mouse input: "),
            new options_entry(input_module.OSD_LIGHTGUNINPUT_PROVIDER, OSDOPTVAL_AUTO,   core_options.option_type.STRING,    "provider for lightgun input: "),
            new options_entry(input_module.OSD_JOYSTICKINPUT_PROVIDER, OSDOPTVAL_AUTO,   core_options.option_type.STRING,    "provider for joystick input: "),

            new options_entry(null,                                   null,              core_options.option_type.HEADER,    "OSD CLI OPTIONS"),
            new options_entry(OSDCOMMAND_LIST_MIDI_DEVICES + ";mlist", "0",              core_options.option_type.COMMAND,   "list available MIDI I/O devices"),
            new options_entry(OSDCOMMAND_LIST_NETWORK_ADAPTERS + ";nlist", "0",          core_options.option_type.COMMAND,   "list available network adapters"),

            new options_entry(null,                                   null,             core_options.option_type.HEADER,     "OSD DEBUGGING OPTIONS"),
            new options_entry(OSDOPTION_DEBUGGER,                     OSDOPTVAL_AUTO,   core_options.option_type.STRING,     "debugger used : "),
            new options_entry(OSDOPTION_DEBUGGER_PORT,                "23946",          core_options.option_type.INTEGER,    "port to use for gdbstub debugger"),
            new options_entry(OSDOPTION_DEBUGGER_FONT + ";dfont",     OSDOPTVAL_AUTO,   core_options.option_type.STRING,     "font to use for debugger views"),
            new options_entry(OSDOPTION_DEBUGGER_FONT_SIZE + ";dfontsize", "0",         core_options.option_type.FLOAT,      "font size to use for debugger views"),
            new options_entry(OSDOPTION_WATCHDOG + ";wdog",           "0",              core_options.option_type.INTEGER,    "force the program to terminate if no updates within specified number of seconds"),

            new options_entry(null,                                   null,             core_options.option_type.HEADER,     "OSD PERFORMANCE OPTIONS"),
            new options_entry(OSDOPTION_NUMPROCESSORS + ";np",        OSDOPTVAL_AUTO,   core_options.option_type.STRING,     "number of processors; this overrides the number the system reports"),
            new options_entry(OSDOPTION_BENCH,                        "0",              core_options.option_type.INTEGER,    "benchmark for the given number of emulated seconds; implies -video none -sound none -nothrottle"),

            new options_entry(null,                                   null,             core_options.option_type.HEADER,     "OSD VIDEO OPTIONS"),
            // OS X can be trusted to have working hardware OpenGL, so default to it on for the best user experience
            new options_entry(OSDOPTION_VIDEO,                        OSDOPTVAL_AUTO,   core_options.option_type.STRING,     "video output method: "),
            new options_entry(OSDOPTION_NUMSCREENS + "(1-4)",         "1",              core_options.option_type.INTEGER,    "number of output screens/windows to create; usually, you want just one"),
            new options_entry(OSDOPTION_WINDOW + ";w",                "0",              core_options.option_type.BOOLEAN,    "enable window mode; otherwise, full screen mode is assumed"),
            new options_entry(OSDOPTION_MAXIMIZE + ";max",            "1",              core_options.option_type.BOOLEAN,    "default to maximized windows"),
            new options_entry(OSDOPTION_WAITVSYNC + ";vs",            "0",              core_options.option_type.BOOLEAN,    "enable waiting for the start of VBLANK before flipping screens (reduces tearing effects)"),
            new options_entry(OSDOPTION_SYNCREFRESH + ";srf",         "0",              core_options.option_type.BOOLEAN,    "enable using the start of VBLANK for throttling instead of the game time"),
            new options_entry(monitor_module.OSD_MONITOR_PROVIDER,    OSDOPTVAL_AUTO,   core_options.option_type.STRING,     "monitor discovery method: "),

            // per-window options
            new options_entry(null,                                   null,             core_options.option_type.HEADER,    "OSD PER-WINDOW VIDEO OPTIONS"),
            new options_entry(OSDOPTION_SCREEN,                       OSDOPTVAL_AUTO,   core_options.option_type.STRING,    "explicit name of the first screen; 'auto' here will try to make a best guess"),
            new options_entry(OSDOPTION_ASPECT + ";screen_aspect",    OSDOPTVAL_AUTO,   core_options.option_type.STRING,    "aspect ratio for all screens; 'auto' here will try to make a best guess"),
            new options_entry(OSDOPTION_RESOLUTION + ";r",            OSDOPTVAL_AUTO,   core_options.option_type.STRING,    "preferred resolution for all screens; format is <width>x<height>[@<refreshrate>] or 'auto'"),
            new options_entry(OSDOPTION_VIEW,                         OSDOPTVAL_AUTO,   core_options.option_type.STRING,    "preferred view for all screens"),

            new options_entry(OSDOPTION_SCREEN + "0",                 OSDOPTVAL_AUTO,   core_options.option_type.STRING,    "explicit name of the first screen; 'auto' here will try to make a best guess"),
            new options_entry(OSDOPTION_ASPECT + "0",                 OSDOPTVAL_AUTO,   core_options.option_type.STRING,    "aspect ratio of the first screen; 'auto' here will try to make a best guess"),
            new options_entry(OSDOPTION_RESOLUTION + "0;r0",          OSDOPTVAL_AUTO,   core_options.option_type.STRING,    "preferred resolution of the first screen; format is <width>x<height>[@<refreshrate>] or 'auto'"),
            new options_entry(OSDOPTION_VIEW + "0",                   OSDOPTVAL_AUTO,   core_options.option_type.STRING,    "preferred view for the first screen"),

            new options_entry(OSDOPTION_SCREEN + "1",                 OSDOPTVAL_AUTO,   core_options.option_type.STRING,    "explicit name of the second screen; 'auto' here will try to make a best guess"),
            new options_entry(OSDOPTION_ASPECT + "1",                 OSDOPTVAL_AUTO,   core_options.option_type.STRING,    "aspect ratio of the second screen; 'auto' here will try to make a best guess"),
            new options_entry(OSDOPTION_RESOLUTION + "1;r1",          OSDOPTVAL_AUTO,   core_options.option_type.STRING,    "preferred resolution of the second screen; format is <width>x<height>[@<refreshrate>] or 'auto'"),
            new options_entry(OSDOPTION_VIEW + "1",                   OSDOPTVAL_AUTO,   core_options.option_type.STRING,    "preferred view for the second screen"),

            new options_entry(OSDOPTION_SCREEN + "2",                 OSDOPTVAL_AUTO,   core_options.option_type.STRING,    "explicit name of the third screen; 'auto' here will try to make a best guess"),
            new options_entry(OSDOPTION_ASPECT + "2",                 OSDOPTVAL_AUTO,   core_options.option_type.STRING,    "aspect ratio of the third screen; 'auto' here will try to make a best guess"),
            new options_entry(OSDOPTION_RESOLUTION + "2;r2",          OSDOPTVAL_AUTO,   core_options.option_type.STRING,    "preferred resolution of the third screen; format is <width>x<height>[@<refreshrate>] or 'auto'"),
            new options_entry(OSDOPTION_VIEW + "2",                   OSDOPTVAL_AUTO,   core_options.option_type.STRING,    "preferred view for the third screen"),

            new options_entry(OSDOPTION_SCREEN + "3",                 OSDOPTVAL_AUTO,   core_options.option_type.STRING,    "explicit name of the fourth screen; 'auto' here will try to make a best guess"),
            new options_entry(OSDOPTION_ASPECT + "3",                 OSDOPTVAL_AUTO,   core_options.option_type.STRING,    "aspect ratio of the fourth screen; 'auto' here will try to make a best guess"),
            new options_entry(OSDOPTION_RESOLUTION + "3;r3",          OSDOPTVAL_AUTO,   core_options.option_type.STRING,    "preferred resolution of the fourth screen; format is <width>x<height>[@<refreshrate>] or 'auto'"),
            new options_entry(OSDOPTION_VIEW + "3",                   OSDOPTVAL_AUTO,   core_options.option_type.STRING,    "preferred view for the fourth screen"),

            // full screen options
            new options_entry(null,                                   null,             core_options.option_type.HEADER,    "OSD FULL SCREEN OPTIONS"),
            new options_entry(OSDOPTION_SWITCHRES,                    "0",              core_options.option_type.BOOLEAN,   "enable resolution switching"),

            new options_entry(null,                                   null,             core_options.option_type.HEADER,    "OSD ACCELERATED VIDEO OPTIONS"),
            new options_entry(OSDOPTION_FILTER + ";glfilter;flt",     "1",              core_options.option_type.BOOLEAN,   "use bilinear filtering when scaling emulated video"),
            new options_entry(OSDOPTION_PRESCALE + "(1-8)",           "1",              core_options.option_type.INTEGER,   "scale emulated video by this factor before applying filters/shaders"),

#if USE_OPENGL
            new options_entry(null,                                   null,             core_options::option_type::HEADER,    "OpenGL-SPECIFIC OPTIONS"),
            new options_entry(OSDOPTION_GL_FORCEPOW2TEXTURE,          "0",              core_options::option_type::BOOLEAN,   "force power-of-two texture sizes (default no)"),
            new options_entry(OSDOPTION_GL_NOTEXTURERECT,             "0",              core_options::option_type::BOOLEAN,   "don't use OpenGL GL_ARB_texture_rectangle (default on)"),
            new options_entry(OSDOPTION_GL_VBO,                       "1",              core_options::option_type::BOOLEAN,   "enable OpenGL VBO if available (default on)"),
            new options_entry(OSDOPTION_GL_PBO,                       "1",              core_options::option_type::BOOLEAN,   "enable OpenGL PBO if available (default on)"),
            new options_entry(OSDOPTION_GL_GLSL,                      "0",              core_options::option_type::BOOLEAN,   "enable OpenGL GLSL if available (default off)"),
            ...
            new options_entry(OSDOPTION_SHADER_MAME + "0",            OSDOPTVAL_NONE,   core_options::option_type::STRING,    "custom OpenGL GLSL shader set mame bitmap 0"),
            new options_entry(OSDOPTION_SHADER_MAME + "1",            OSDOPTVAL_NONE,   core_options::option_type::STRING,    "custom OpenGL GLSL shader set mame bitmap 1"),
            new options_entry(OSDOPTION_SHADER_MAME + "2",            OSDOPTVAL_NONE,   core_options::option_type::STRING,    "custom OpenGL GLSL shader set mame bitmap 2"),
            new options_entry(OSDOPTION_SHADER_MAME + "3",            OSDOPTVAL_NONE,   core_options::option_type::STRING,    "custom OpenGL GLSL shader set mame bitmap 3"),
            new options_entry(OSDOPTION_SHADER_MAME + "4",            OSDOPTVAL_NONE,   core_options::option_type::STRING,    "custom OpenGL GLSL shader set mame bitmap 4"),
            new options_entry(OSDOPTION_SHADER_MAME + "5",            OSDOPTVAL_NONE,   core_options::option_type::STRING,    "custom OpenGL GLSL shader set mame bitmap 5"),
            new options_entry(OSDOPTION_SHADER_MAME + "6",            OSDOPTVAL_NONE,   core_options::option_type::STRING,    "custom OpenGL GLSL shader set mame bitmap 6"),
            new options_entry(OSDOPTION_SHADER_MAME + "7",            OSDOPTVAL_NONE,   core_options::option_type::STRING,    "custom OpenGL GLSL shader set mame bitmap 7"),
            new options_entry(OSDOPTION_SHADER_MAME + "8",            OSDOPTVAL_NONE,   core_options::option_type::STRING,    "custom OpenGL GLSL shader set mame bitmap 8"),
            new options_entry(OSDOPTION_SHADER_MAME + "9",            OSDOPTVAL_NONE,   core_options::option_type::STRING,    "custom OpenGL GLSL shader set mame bitmap 9"),
            new options_entry(OSDOPTION_SHADER_SCREEN + "0",          OSDOPTVAL_NONE,   core_options::option_type::STRING,    "custom OpenGL GLSL shader screen bitmap 0"),
            new options_entry(OSDOPTION_SHADER_SCREEN + "1",          OSDOPTVAL_NONE,   core_options::option_type::STRING,    "custom OpenGL GLSL shader screen bitmap 1"),
            new options_entry(OSDOPTION_SHADER_SCREEN + "2",          OSDOPTVAL_NONE,   core_options::option_type::STRING,    "custom OpenGL GLSL shader screen bitmap 2"),
            new options_entry(OSDOPTION_SHADER_SCREEN + "3",          OSDOPTVAL_NONE,   core_options::option_type::STRING,    "custom OpenGL GLSL shader screen bitmap 3"),
            new options_entry(OSDOPTION_SHADER_SCREEN + "4",          OSDOPTVAL_NONE,   core_options::option_type::STRING,    "custom OpenGL GLSL shader screen bitmap 4"),
            new options_entry(OSDOPTION_SHADER_SCREEN + "5",          OSDOPTVAL_NONE,   core_options::option_type::STRING,    "custom OpenGL GLSL shader screen bitmap 5"),
            new options_entry(OSDOPTION_SHADER_SCREEN + "6",          OSDOPTVAL_NONE,   core_options::option_type::STRING,    "custom OpenGL GLSL shader screen bitmap 6"),
            new options_entry(OSDOPTION_SHADER_SCREEN + "7",          OSDOPTVAL_NONE,   core_options::option_type::STRING,    "custom OpenGL GLSL shader screen bitmap 7"),
            new options_entry(OSDOPTION_SHADER_SCREEN + "8",          OSDOPTVAL_NONE,   core_options::option_type::STRING,    "custom OpenGL GLSL shader screen bitmap 8"),
            new options_entry(OSDOPTION_SHADER_SCREEN + "9",          OSDOPTVAL_NONE,   core_options::option_type::STRING,    "custom OpenGL GLSL shader screen bitmap 9"),
#endif

            new options_entry(null,                                   null,             core_options.option_type.HEADER,    "OSD SOUND OPTIONS"),
            new options_entry(OSDOPTION_SOUND,                        OSDOPTVAL_AUTO,   core_options.option_type.STRING,    "sound output method: "),
            new options_entry(OSDOPTION_AUDIO_LATENCY + "(0-5)",      "2",              core_options.option_type.INTEGER,   "set audio latency (increase to reduce glitches, decrease for responsiveness)"),
...
#if SDLMAME_MACOSX
            new options_entry(null,                                   null,             core_options::option_type::HEADER,    "CoreAudio-SPECIFIC OPTIONS"),
            new options_entry(OSDOPTION_AUDIO_OUTPUT,                 OSDOPTVAL_AUTO,   core_options::option_type::STRING,    "audio output device"),
            new options_entry(OSDOPTION_AUDIO_EFFECT + "0",           OSDOPTVAL_NONE,   core_options::option_type::STRING,    "AudioUnit effect 0"),
            new options_entry(OSDOPTION_AUDIO_EFFECT + "1",           OSDOPTVAL_NONE,   core_options::option_type::STRING,    "AudioUnit effect 1"),
            new options_entry(OSDOPTION_AUDIO_EFFECT + "2",           OSDOPTVAL_NONE,   core_options::option_type::STRING,    "AudioUnit effect 2"),
            new options_entry(OSDOPTION_AUDIO_EFFECT + "3",           OSDOPTVAL_NONE,   core_options::option_type::STRING,    "AudioUnit effect 3"),
            new options_entry(OSDOPTION_AUDIO_EFFECT + "4",           OSDOPTVAL_NONE,   core_options::option_type::STRING,    "AudioUnit effect 4"),
            new options_entry(OSDOPTION_AUDIO_EFFECT + "5",           OSDOPTVAL_NONE,   core_options::option_type::STRING,    "AudioUnit effect 5"),
            new options_entry(OSDOPTION_AUDIO_EFFECT + "6",           OSDOPTVAL_NONE,   core_options::option_type::STRING,    "AudioUnit effect 6"),
            new options_entry(OSDOPTION_AUDIO_EFFECT + "7",           OSDOPTVAL_NONE,   core_options::option_type::STRING,    "AudioUnit effect 7"),
            new options_entry(OSDOPTION_AUDIO_EFFECT + "8",           OSDOPTVAL_NONE,   core_options::option_type::STRING,    "AudioUnit effect 8"),
            new options_entry(OSDOPTION_AUDIO_EFFECT + "9",           OSDOPTVAL_NONE,   core_options::option_type::STRING,    "AudioUnit effect 9"),
#endif

            new options_entry(null,                                   null,              core_options.option_type.HEADER,  "BGFX POST-PROCESSING OPTIONS"),
            new options_entry(OSDOPTION_BGFX_PATH,                    "bgfx",            core_options.option_type.STRING,  "path to BGFX-related files"),
            new options_entry(OSDOPTION_BGFX_BACKEND,                 "auto",            core_options.option_type.STRING,  "BGFX backend to use (d3d9, d3d11, d3d12, metal, opengl, gles, vulkan)"),
            new options_entry(OSDOPTION_BGFX_DEBUG,                   "0",               core_options.option_type.BOOLEAN, "enable BGFX debugging statistics"),
            new options_entry(OSDOPTION_BGFX_SCREEN_CHAINS,           "default",         core_options.option_type.STRING,  "comma-delimited list of screen chain JSON names, colon-delimited per-window"),
            new options_entry(OSDOPTION_BGFX_SHADOW_MASK,             "slot-mask.png",   core_options.option_type.STRING,  "shadow mask texture name"),
            new options_entry(OSDOPTION_BGFX_LUT,                     "lut-default.png", core_options.option_type.STRING,  "LUT texture name"),
            new options_entry(OSDOPTION_BGFX_AVI_NAME,                OSDOPTVAL_AUTO,    core_options.option_type.STRING,  "filename for BGFX output logging"),
