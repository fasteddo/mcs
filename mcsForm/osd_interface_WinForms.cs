...
namespace mcsForm
{
    public class osd_options_WinForms : osd_options  // windows_options
    {
        ...
        {
            // debugging options
            new options_entry(null,                                           null,       core_options.option_type.HEADER,     "WINDOWS DEBUGGING OPTIONS"),
            new options_entry(WINOPTION_DEBUGGER_FONT + ";dfont",             "Lucida Console", core_options.option_type.STRING,"specifies the font to use for debugging; defaults to Lucida Console"),
            new options_entry(WINOPTION_DEBUGGER_FONT_SIZE + ";dfontsize",    "9",        core_options.option_type.FLOAT,      "specifies the font size to use for debugging; defaults to 9 pt"),

            // performance options
            new options_entry(null,                                           null,       core_options.option_type.HEADER,     "WINDOWS PERFORMANCE OPTIONS"),
            new options_entry(WINOPTION_PRIORITY + "(-15-1)",                 "0",        core_options.option_type.INTEGER,    "thread priority for the main game thread; range from -15 to 1"),
            new options_entry(WINOPTION_PROFILE,                              "0",        core_options.option_type.INTEGER,    "enable profiling, specifying the stack depth to track"),

            // video options
            new options_entry(null,                                           null,       core_options.option_type.HEADER,     "WINDOWS VIDEO OPTIONS"),
            new options_entry(WINOPTION_PRESCALE,                             "1",        core_options.option_type.INTEGER,    "scale screen rendering by this amount in software"),
            new options_entry(WINOPTION_MENU,                                 "0",        core_options.option_type.BOOLEAN,    "enable menu bar if available by UI implementation"),

            // DirectDraw-specific options
            new options_entry(null,                                           null,       core_options.option_type.HEADER,     "DIRECTDRAW-SPECIFIC OPTIONS"),
            new options_entry(WINOPTION_HWSTRETCH + ";hws",                   "1",        core_options.option_type.BOOLEAN,    "enable hardware stretching"),

            // Direct3D-specific options
            new options_entry(null,                                           null,       core_options.option_type.HEADER,     "DIRECT3D-SPECIFIC OPTIONS"),
            new options_entry(WINOPTION_FILTER + ";d3dfilter;flt",            "1",        core_options.option_type.BOOLEAN,    "enable bilinear filtering on screen output"),

            // post-processing options
            new options_entry(null,                                                     null,        core_options.option_type.HEADER,     "DIRECT3D POST-PROCESSING OPTIONS"),
            new options_entry(WINOPTION_HLSLPATH,                                       "hlsl",      core_options.option_type.STRING,     "path to hlsl files"),
            new options_entry(WINOPTION_HLSL_ENABLE + ";hlsl",                          "0",         core_options.option_type.BOOLEAN,    "enable HLSL post-processing (PS3.0 required)"),
            new options_entry(WINOPTION_HLSL_OVERSAMPLING,                              "0",         core_options.option_type.BOOLEAN,    "enable HLSL oversampling"),
            new options_entry(WINOPTION_HLSL_WRITE,                                     OSDOPTVAL_AUTO, core_options.option_type.STRING,   "enable HLSL AVI writing (huge disk bandwidth suggested)"),
            new options_entry(WINOPTION_HLSL_SNAP_WIDTH,                                "2048",      core_options.option_type.STRING,     "HLSL upscaled-snapshot width"),
            new options_entry(WINOPTION_HLSL_SNAP_HEIGHT,                               "1536",      core_options.option_type.STRING,     "HLSL upscaled-snapshot height"),
            new options_entry(WINOPTION_SHADOW_MASK_TILE_MODE,                          "0",         core_options.option_type.INTEGER,    "shadow mask tile mode (0 for screen based, 1 for source based)"),
            new options_entry(WINOPTION_SHADOW_MASK_ALPHA + ";fs_shadwa(0.0-1.0)",      "0.0",       core_options.option_type.FLOAT,      "shadow mask alpha-blend value (1.0 is fully blended, 0.0 is no mask)"),
            new options_entry(WINOPTION_SHADOW_MASK_TEXTURE + ";fs_shadwt(0.0-1.0)",    "aperture.png", core_options.option_type.STRING,  "shadow mask texture name"),
            new options_entry(WINOPTION_SHADOW_MASK_COUNT_X + ";fs_shadww",             "320",       core_options.option_type.INTEGER,    "shadow mask width, in phosphor dots"),
            new options_entry(WINOPTION_SHADOW_MASK_COUNT_Y + ";fs_shadwh",             "240",       core_options.option_type.INTEGER,    "shadow mask height, in phosphor dots"),
            new options_entry(WINOPTION_SHADOW_MASK_USIZE + ";fs_shadwu(0.0-1.0)",      "0.09375",   core_options.option_type.FLOAT,      "shadow mask texture size in U direction"),
            new options_entry(WINOPTION_SHADOW_MASK_VSIZE + ";fs_shadwv(0.0-1.0)",      "0.109375",  core_options.option_type.FLOAT,      "shadow mask texture size in V direction"),
            new options_entry(WINOPTION_SHADOW_MASK_UOFFSET + ";fs_shadwou(-1.0-1.0)",  "0.0",       core_options.option_type.FLOAT,      "shadow mask texture offset, in U direction"),
            new options_entry(WINOPTION_SHADOW_MASK_VOFFSET + ";fs_shadwov(-1.0-1.0)",  "0.0",       core_options.option_type.FLOAT,      "shadow mask texture offset, in V direction"),
            new options_entry(WINOPTION_DISTORTION + ";fs_dist(-1.0-1.0)",              "0.0",       core_options.option_type.FLOAT,      "screen distortion amount"),
            new options_entry(WINOPTION_CUBIC_DISTORTION + ";fs_cubedist(-1.0-1.0)",    "0.0",       core_options.option_type.FLOAT,      "screen cubic distortion amount"),
            new options_entry(WINOPTION_DISTORT_CORNER + ";fs_distc(0.0-1.0)",          "0.0",       core_options.option_type.FLOAT,      "screen distort corner amount"),
            new options_entry(WINOPTION_ROUND_CORNER + ";fs_rndc(0.0-1.0)",             "0.0",       core_options.option_type.FLOAT,      "screen round corner amount"),
            new options_entry(WINOPTION_SMOOTH_BORDER + ";fs_smob(0.0-1.0)",            "0.0",       core_options.option_type.FLOAT,      "screen smooth border amount"),
            new options_entry(WINOPTION_REFLECTION + ";fs_ref(0.0-1.0)",                "0.0",       core_options.option_type.FLOAT,      "screen reflection amount"),
            new options_entry(WINOPTION_VIGNETTING + ";fs_vig(0.0-1.0)",                "0.0",       core_options.option_type.FLOAT,      "image vignetting amount"),
            /* Beam-related values below this line*/
            new options_entry(WINOPTION_SCANLINE_AMOUNT + ";fs_scanam(0.0-4.0)",        "0.0",       core_options.option_type.FLOAT,      "overall alpha scaling value for scanlines"),
            new options_entry(WINOPTION_SCANLINE_SCALE + ";fs_scansc(0.0-4.0)",         "1.0",       core_options.option_type.FLOAT,      "overall height scaling value for scanlines"),
            new options_entry(WINOPTION_SCANLINE_HEIGHT + ";fs_scanh(0.0-4.0)",         "1.0",       core_options.option_type.FLOAT,      "individual height scaling value for scanlines"),
            new options_entry(WINOPTION_SCANLINE_VARIATION + ";fs_scanv(0.0-4.0)",      "1.0",       core_options.option_type.FLOAT,      "individual height varying value for scanlines"),
            new options_entry(WINOPTION_SCANLINE_BRIGHT_SCALE + ";fs_scanbs(0.0-2.0)",  "1.0",       core_options.option_type.FLOAT,      "overall brightness scaling value for scanlines (multiplicative)"),
            new options_entry(WINOPTION_SCANLINE_BRIGHT_OFFSET + ";fs_scanbo(0.0-1.0)", "0.0",       core_options.option_type.FLOAT,      "overall brightness offset value for scanlines (additive)"),
            new options_entry(WINOPTION_SCANLINE_JITTER + ";fs_scanjt(0.0-4.0)",        "0.0",       core_options.option_type.FLOAT,      "overall interlace jitter scaling value for scanlines"),
            new options_entry(WINOPTION_HUM_BAR_ALPHA + ";fs_humba(0.0-1.0)",           "0.0",       core_options.option_type.FLOAT,      "overall alpha scaling value for hum bar"),
            new options_entry(WINOPTION_DEFOCUS + ";fs_focus",                          "0.0,0.0",   core_options.option_type.STRING,     "overall defocus value in screen-relative coords"),
            new options_entry(WINOPTION_CONVERGE_X + ";fs_convx",                       "0.0,0.0,0.0", core_options.option_type.STRING,    "convergence in screen-relative X direction"),
            new options_entry(WINOPTION_CONVERGE_Y + ";fs_convy",                       "0.0,0.0,0.0", core_options.option_type.STRING,    "convergence in screen-relative Y direction"),
            new options_entry(WINOPTION_RADIAL_CONVERGE_X + ";fs_rconvx",               "0.0,0.0,0.0", core_options.option_type.STRING,    "radial convergence in screen-relative X direction"),
            new options_entry(WINOPTION_RADIAL_CONVERGE_Y + ";fs_rconvy",               "0.0,0.0,0.0", core_options.option_type.STRING,    "radial convergence in screen-relative Y direction"),
            /* RGB colorspace convolution below this line */
            new options_entry(WINOPTION_RED_RATIO + ";fs_redratio",                     "1.0,0.0,0.0", core_options.option_type.STRING,    "red output signal generated by input signal"),
            new options_entry(WINOPTION_GRN_RATIO + ";fs_grnratio",                     "0.0,1.0,0.0", core_options.option_type.STRING,    "green output signal generated by input signal"),
            new options_entry(WINOPTION_BLU_RATIO + ";fs_bluratio",                     "0.0,0.0,1.0", core_options.option_type.STRING,    "blue output signal generated by input signal"),
            new options_entry(WINOPTION_SATURATION + ";fs_sat(0.0-4.0)",                "1.4",         core_options.option_type.FLOAT,     "saturation scaling value"),
            new options_entry(WINOPTION_OFFSET + ";fs_offset",                          "0.0,0.0,0.0", core_options.option_type.STRING,    "signal offset value (additive)"),
            new options_entry(WINOPTION_SCALE + ";fs_scale",                            "0.95,0.95,0.95", core_options.option_type.STRING, "signal scaling value (multiplicative)"),
            new options_entry(WINOPTION_POWER + ";fs_power",                            "0.8,0.8,0.8", core_options.option_type.STRING,    "signal power value (exponential)"),
            new options_entry(WINOPTION_FLOOR + ";fs_floor",                            "0.05,0.05,0.05", core_options.option_type.STRING, "signal floor level"),
            new options_entry(WINOPTION_PHOSPHOR + ";fs_phosphor",                      "0.4,0.4,0.4", core_options.option_type.STRING,    "phosphorescence decay rate (0.0 is instant, 1.0 is forever)"),
            new options_entry(WINOPTION_CHROMA_MODE,                                    "3",                 core_options.option_type.INTEGER,    "number of phosphors to use: 1 - monochrome, 2 - dichrome, 3 - trichrome (color)"),
            new options_entry(WINOPTION_CHROMA_CONVERSION_GAIN,                         "0.299,0.587,0.114", core_options.option_type.STRING,     "gain to be applied when summing RGB signal for monochrome and dichrome modes"),
            new options_entry(WINOPTION_CHROMA_A,                                       "0.64,0.33",         core_options.option_type.STRING,     "chromaticity coordinate for first phosphor"),
            new options_entry(WINOPTION_CHROMA_B,                                       "0.30,0.60",         core_options.option_type.STRING,     "chromaticity coordinate for second phosphor"),
            new options_entry(WINOPTION_CHROMA_C,                                       "0.15,0.06",         core_options.option_type.STRING,     "chromaticity coordinate for third phosphor"),
            new options_entry(WINOPTION_CHROMA_Y_GAIN,                                  "0.2126,0.7152,0.0722", core_options.option_type.STRING,  "gain to be applied for each phosphor"),
            /* NTSC simulation below this line */
            new options_entry(null,                                                     null,         core_options.option_type.HEADER,     "NTSC POST-PROCESSING OPTIONS"),
            new options_entry(WINOPTION_YIQ_ENABLE + ";yiq",                            "0",          core_options.option_type.BOOLEAN,    "enable YIQ-space HLSL post-processing"),
            new options_entry(WINOPTION_YIQ_JITTER + ";yiqj",                           "0.0",        core_options.option_type.FLOAT,      "jitter for the NTSC signal processing"),
            new options_entry(WINOPTION_YIQ_CCVALUE + ";yiqcc",                         "3.59754545", core_options.option_type.FLOAT,      "color Carrier frequency for NTSC signal processing"),
            new options_entry(WINOPTION_YIQ_AVALUE + ";yiqa",                           "0.5",        core_options.option_type.FLOAT,      "A value for NTSC signal processing"),
            new options_entry(WINOPTION_YIQ_BVALUE + ";yiqb",                           "0.5",        core_options.option_type.FLOAT,      "B value for NTSC signal processing"),
            new options_entry(WINOPTION_YIQ_OVALUE + ";yiqo",                           "1.570796325",core_options.option_type.FLOAT,     "outgoing Color Carrier phase offset for NTSC signal processing"),
            new options_entry(WINOPTION_YIQ_PVALUE + ";yiqp",                           "1.0",        core_options.option_type.FLOAT,      "incoming Pixel Clock scaling value for NTSC signal processing"),
            new options_entry(WINOPTION_YIQ_NVALUE + ";yiqn",                           "1.0",        core_options.option_type.FLOAT,      "Y filter notch width for NTSC signal processing"),
            new options_entry(WINOPTION_YIQ_YVALUE + ";yiqy",                           "6.0",        core_options.option_type.FLOAT,      "Y filter cutoff frequency for NTSC signal processing"),
            new options_entry(WINOPTION_YIQ_IVALUE + ";yiqi",                           "1.2",        core_options.option_type.FLOAT,      "I filter cutoff frequency for NTSC signal processing"),
            new options_entry(WINOPTION_YIQ_QVALUE + ";yiqq",                           "0.6",        core_options.option_type.FLOAT,      "Q filter cutoff frequency for NTSC signal processing"),
            new options_entry(WINOPTION_YIQ_SCAN_TIME + ";yiqsc",                       "52.6",       core_options.option_type.FLOAT,      "horizontal scanline duration for NTSC signal processing (in usec)"),
            new options_entry(WINOPTION_YIQ_PHASE_COUNT + ";yiqp",                      "2",          core_options.option_type.INTEGER,    "phase count value for NTSC signal processing"),
            /* Vector simulation below this line */
            new options_entry(null,                                                     null,         core_options.option_type.HEADER,     "VECTOR POST-PROCESSING OPTIONS"),
            new options_entry(WINOPTION_VECTOR_BEAM_SMOOTH + ";vecsmooth",              "0.0",        core_options.option_type.FLOAT,      "vector beam smoothness"),
            new options_entry(WINOPTION_VECTOR_LENGTH_SCALE + ";veclength",             "0.8",        core_options.option_type.FLOAT,      "maximum vector attenuation"),
            new options_entry(WINOPTION_VECTOR_LENGTH_RATIO + ";vecsize",               "500.0",      core_options.option_type.FLOAT,      "minimum vector length affected by attenuation (vector length to screen size ratio)"),
            /* Bloom below this line */
            new options_entry(null,                                                     null,         core_options.option_type.HEADER,     "BLOOM POST-PROCESSING OPTIONS"),
            new options_entry(WINOPTION_BLOOM_BLEND_MODE,                               "0",                 core_options.option_type.INTEGER,    "bloom blend mode (0 for brighten, 1 for darken)"),
            new options_entry(WINOPTION_BLOOM_SCALE,                                    "0.0",               core_options.option_type.FLOAT,      "intensity factor for bloom"),
            new options_entry(WINOPTION_BLOOM_OVERDRIVE,                                "1.0,1.0,1.0",       core_options.option_type.STRING,     "overdrive factor for bloom"),
            new options_entry(WINOPTION_BLOOM_LEVEL0_WEIGHT,                            "1.0",               core_options.option_type.FLOAT,      "bloom level 0 weight (full-size target)"),
            new options_entry(WINOPTION_BLOOM_LEVEL1_WEIGHT,                            "0.64",              core_options.option_type.FLOAT,      "bloom level 1 weight (1/4 smaller that level 0 target)"),
            new options_entry(WINOPTION_BLOOM_LEVEL2_WEIGHT,                            "0.32",              core_options.option_type.FLOAT,      "bloom level 2 weight (1/4 smaller that level 1 target)"),
            new options_entry(WINOPTION_BLOOM_LEVEL3_WEIGHT,                            "0.16",              core_options.option_type.FLOAT,      "bloom level 3 weight (1/4 smaller that level 2 target)"),
            new options_entry(WINOPTION_BLOOM_LEVEL4_WEIGHT,                            "0.08",              core_options.option_type.FLOAT,      "bloom level 4 weight (1/4 smaller that level 3 target)"),
            new options_entry(WINOPTION_BLOOM_LEVEL5_WEIGHT,                            "0.06",              core_options.option_type.FLOAT,      "bloom level 5 weight (1/4 smaller that level 4 target)"),
            new options_entry(WINOPTION_BLOOM_LEVEL6_WEIGHT,                            "0.04",              core_options.option_type.FLOAT,      "bloom level 6 weight (1/4 smaller that level 5 target)"),
            new options_entry(WINOPTION_BLOOM_LEVEL7_WEIGHT,                            "0.02",              core_options.option_type.FLOAT,      "bloom level 7 weight (1/4 smaller that level 6 target)"),
            new options_entry(WINOPTION_BLOOM_LEVEL8_WEIGHT,                            "0.01",              core_options.option_type.FLOAT,      "bloom level 8 weight (1/4 smaller that level 7 target)"),
            new options_entry(WINOPTION_LUT_TEXTURE,                                    "",                  core_options.option_type.STRING,     "3D LUT texture filename for screen, PNG format"),
            new options_entry(WINOPTION_LUT_ENABLE,                                     "0",                 core_options.option_type.BOOLEAN,    "Enables 3D LUT to be applied to screen after post-processing"),
            new options_entry(WINOPTION_UI_LUT_TEXTURE,                                 "",                  core_options.option_type.STRING,     "3D LUT texture filename of UI, PNG format"),
            new options_entry(WINOPTION_UI_LUT_ENABLE,                                  "0",                 core_options.option_type.BOOLEAN,    "enable 3D LUT to be applied to UI and artwork after post-processing"),

            // full screen options
            new options_entry(null,                                             null,       core_options.option_type.HEADER,     "FULL SCREEN OPTIONS"),
            new options_entry(WINOPTION_TRIPLEBUFFER + ";tb",                   "0",        core_options.option_type.BOOLEAN,    "enable triple buffering"),
            new options_entry(WINOPTION_FULLSCREENBRIGHTNESS + ";fsb(0.1-2.0)", "1.0",      core_options.option_type.FLOAT,      "brightness value in full screen mode"),
            new options_entry(WINOPTION_FULLSCREENCONTRAST + ";fsc(0.1-2.0)",   "1.0",      core_options.option_type.FLOAT,      "contrast value in full screen mode"),
            new options_entry(WINOPTION_FULLSCREENGAMMA + ";fsg(0.1-3.0)",      "1.0",      core_options.option_type.FLOAT,      "gamma value in full screen mode"),

            // input options
            new options_entry(null,                                             null,       core_options.option_type.HEADER,     "INPUT DEVICE OPTIONS"),
            new options_entry(WINOPTION_GLOBAL_INPUTS,                          "0",        core_options.option_type.BOOLEAN,    "enable global inputs"),
            new options_entry(WINOPTION_DUAL_LIGHTGUN + ";dual",                "0",        core_options.option_type.BOOLEAN,    "enable dual lightgun input"),
    ...
    public class osd_interface_WinForms : osd_common_t
    {
        ...
        public override void init(running_machine machine)
        {
            ...
            if (options.oslog())
                machine.add_logerror_callback(osd_printf_debug);
        ...
        public void ui_input_push_mouse_wheel_event(int x, int y, short delta, int ucNumLines) { machine().ui_input().push_mouse_wheel_event(m_target, x, y, delta, ucNumLines); }
